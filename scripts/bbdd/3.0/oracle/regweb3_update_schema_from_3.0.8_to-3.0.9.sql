...
INSERT INTO rwe_propiedadglobal(id,clave,valor,tipo,descripcion,entidad) SELECT RWE_ALL_SEQ.nextVal, 'es.caib.regweb3.postproceso.plugin','org.fundaciobit.plugins.postproceso.postprocesolocal.PostProcesoLocalPostProcesoPlugin',1,'Clase del Plugin de post-proceso',1,'Tipos Mime permitidos para los anexos',id FROM rwe_entidad;
...
INSERT INTO rwe_propiedadglobal(id,clave,valor,tipo,descripcion,entidad) SELECT RWE_ALL_SEQ.nextVal, 'es.caib.regweb3.justificante.plugin','org.fundaciobit.plugins.justificante.caib.CaibJustificantePlugin',1,'Plugin de justificante CAIB',id FROM rwe_entidad;
