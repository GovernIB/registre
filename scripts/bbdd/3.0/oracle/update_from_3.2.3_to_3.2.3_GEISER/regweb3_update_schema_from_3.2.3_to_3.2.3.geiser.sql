...
ALTER TABLE RWE_ENTIDAD ADD ULTIMA_EJECUCION_VERIF_ANEXOS NUMBER(19,0);
...
(
    ...
    ORGAN_EMISSOR_CODI      VARCHAR2(9 CHAR) NOT NULL,
    ORGAN_EMISSOR_NOM 		VARCHAR2(255 CHAR) NOT NULL,
    DATA 					TIMESTAMP,
    TITULAR_NIF				VARCHAR2(9 CHAR) NOT NULL,
    TITULAR_NOM				VARCHAR2(255 CHAR) NOT NULL,
    ESTAT					VARCHAR2(10 CHAR) NOT NULL,
    ESTAT_NOTIFICA			VARCHAR2(20 CHAR) NOT NULL
);
