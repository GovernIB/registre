...
create table RWE_ENTIDAD (
   ID number(19,0) not null,
    ...
    REG_SALIDAS_PERSONAS number(1,0),
...
create index RWE_POU_ORG_FK_I on RWE_PERMORGUSU (ORGANISMO) TABLESPACE REGWEB_INDEX;
...
alter table RWE_PERSONA
   add constraint RWE_PERSONA_DOCUMENTO_UK unique (DOCUMENTO);
