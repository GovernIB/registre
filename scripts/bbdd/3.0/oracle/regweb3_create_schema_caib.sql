...
-- INICI Indexes
create
index RWE_ANEXO_REGDET_FK_I on RWE_ANEXO (REGISTRODETALLE) TABLESPACE REGWEB_INDEX;
    create
index RWE_ANEXO_TDOCAL_FK_I on RWE_ANEXO (TDOCUMENTAL) TABLESPACE REGWEB_INDEX;
    create
index RWE_CATCOM_CATPAI_FK_I on RWE_CATCOMUNIDADAUTONOMA (PAIS) TABLESPACE REGWEB_INDEX;
    create
index RWE_CATLOC_CATENG_FK_I on RWE_CATLOCALIDAD (ENTIDADGEOGRAFICA) TABLESPACE REGWEB_INDEX;
    create
index RWE_CATLOC_CATPRO_FK_I on RWE_CATLOCALIDAD (PROVINCIA) TABLESPACE REGWEB_INDEX;
    create
index RWE_CATPRO_CATCAU_FK_I on RWE_CATPROVINCIA (COMUNIDADAUTONOMA) TABLESPACE REGWEB_INDEX;
    create
index RWE_DESCAR_ENTIDA_FK_I on RWE_DESCARGA (ENTIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_ENTIDA_PRO_FK_I on RWE_ENTIDAD (PROPIETARIO) TABLESPACE REGWEB_INDEX;
    create
index RWE_HRE_REGENT_FK_I on RWE_HISTORICO_REGISTRO_ENTRADA (REGISTRO_ENTRADA) TABLESPACE REGWEB_INDEX;
    create
index RWE_HRE_USUENT_FK_I on RWE_HISTORICO_REGISTRO_ENTRADA (USUARIO) TABLESPACE REGWEB_INDEX;
    create
index RWE_INT_ENTIDAD_FK_I on RWE_INTEGRACION (ENTIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_INTERES_CATPAI_FK_I on RWE_INTERESADO (PAIS) TABLESPACE REGWEB_INDEX;
    create
index RWE_INTERES_CATLOC_FK_I on RWE_INTERESADO (LOCALIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_INTERES_REPADO_FK_I on RWE_INTERESADO (REPRESENTADO) TABLESPACE REGWEB_INDEX;
    create
index RWE_INTERES_REPANT_FK_I on RWE_INTERESADO (REPRESENTANTE) TABLESPACE REGWEB_INDEX;
    create
index RWE_LIBRO_CONSAL_FK_I on RWE_LIBRO (CONTADOR_SALIDA) TABLESPACE REGWEB_INDEX;
    create
index RWE_LIBRO_ORGANI_FK_I on RWE_LIBRO (ORGANISMO) TABLESPACE REGWEB_INDEX;
    create
index RWE_LIBRO_CONOFI_FK_I on RWE_LIBRO (CONTADOR_OFICIO_REMISION) TABLESPACE REGWEB_INDEX;
    create
index RWE_LIBRO_CONENT_FK_I on RWE_LIBRO (CONTADOR_ENTRADA) TABLESPACE REGWEB_INDEX;
    create
index RWE_LOPD_USUENT_FK_I on RWE_LOPD (USUARIO) TABLESPACE REGWEB_INDEX;
    create
index RWE_LOPD_LIBRO_FK_I on RWE_LOPD (LIBRO) TABLESPACE REGWEB_INDEX;
    create
index RWE_MODOFI_ENTIDA_FK_I on RWE_MODELO_OFICIO_REMISION (ENTIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_MODOFI_ARCHIV_FK_I on RWE_MODELO_OFICIO_REMISION (MODELO) TABLESPACE REGWEB_INDEX;
    create
index RWE_MODREB_ENTIDA_FK_I on RWE_MODELO_RECIBO (ENTIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_MODREB_ARCHIV_FK_I on RWE_MODELO_RECIBO (MODELO) TABLESPACE REGWEB_INDEX;
    create
index RWE_NOTIF_DEST_FK_I on RWE_NOTIFICACION (DESTINATARIO) TABLESPACE REGWEB_INDEX;
    create
index RWE_NOTIF_REMIT_FK_I on RWE_NOTIFICACION (REMITENTE) TABLESPACE REGWEB_INDEX;
    create
index RWE_OFICIN_PAIS_FK_I on RWE_OFICINA (PAIS) TABLESPACE REGWEB_INDEX;
    create
index RWE_OFICIN_ESTENT_FK_I on RWE_OFICINA (ESTADO) TABLESPACE REGWEB_INDEX;
    create
index RWE_OFICIN_COMUNI_FK_I on RWE_OFICINA (COMUNIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_OFICIN_TVIA_FK_I on RWE_OFICINA (TIPOVIA) TABLESPACE REGWEB_INDEX;
    create
index RWE_OFICIN_LOCALI_FK_I on RWE_OFICINA (LOCALIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_OFICIN_OFICIN_FK_I on RWE_OFICINA (OFICINARESPONSABLE) TABLESPACE REGWEB_INDEX;
    create
index RWE_OFICIN_ORGANI_FK_I on RWE_OFICINA (ORGANISMORESPONSABLE) TABLESPACE REGWEB_INDEX;
    create
index RWE_OFIREM_ORGANI_FK_I on RWE_OFICIO_REMISION (ORGANISMODEST) TABLESPACE REGWEB_INDEX;
    create
index RWE_OFIREM_OFICIN_FK_I on RWE_OFICIO_REMISION (OFICINA) TABLESPACE REGWEB_INDEX;
    create
index RWE_OFIREM_LIBRO_FK_I on RWE_OFICIO_REMISION (LIBRO) TABLESPACE REGWEB_INDEX;
    create
index RWE_OFIREM_USUARI_FK_I on RWE_OFICIO_REMISION (USUARIO) TABLESPACE REGWEB_INDEX;
    create
index RWE_ORGANI_SUPERI_FK_I on RWE_ORGANISMO (ORGANISMOSUPERIOR) TABLESPACE REGWEB_INDEX;
    create
index RWE_ORGANI_TVIA_FK_I on RWE_ORGANISMO (TIPOVIA) TABLESPACE REGWEB_INDEX;
    create
index RWE_ORGANI_LOCALI_FK_I on RWE_ORGANISMO (LOCALIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_ORGANI_EDP_FK_I on RWE_ORGANISMO (EDPRINCIPAL) TABLESPACE REGWEB_INDEX;
    create
index RWE_ORGANI_PROVIN_FK_I on RWE_ORGANISMO (CODAMBPROVINCIA) TABLESPACE REGWEB_INDEX;
    create
index RWE_ORGANI_ESTADO_FK_I on RWE_ORGANISMO (ESTADO) TABLESPACE REGWEB_INDEX;
    create
index RWE_ORGANI_ENTIDA_FK_I on RWE_ORGANISMO (ENTIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_ORGANI_RAIZ_FK_I on RWE_ORGANISMO (ORGANISMORAIZ) TABLESPACE REGWEB_INDEX;
    create
index RWE_ORGANI_CAUTON_FK_I on RWE_ORGANISMO (CODAMBCOMUNIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_ORGANI_PAIS_FK_I on RWE_ORGANISMO (PAIS) TABLESPACE REGWEB_INDEX;
    create
index RWE_PELIUS_USUARI_FK_I on RWE_PERMLIBUSU (USUARIO) TABLESPACE REGWEB_INDEX;
    create
index RWE_PELIUS_LIBRO_FK_I on RWE_PERMLIBUSU (LIBRO) TABLESPACE REGWEB_INDEX;
    create
index RWE_POU_ORG_FK_I on RWE_PERMORGUSU (ORGANISMO) TABLESPACE REGWEB_INDEX;
    create
index RWE_POU_USUARI_FK_I on RWE_PERMORGUSU (USUARIO) TABLESPACE REGWEB_INDEX;
    create
index RWE_PERSONA_ENTIDAD_FK_I on RWE_PERSONA (ENTIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_PLUGI_ENTIDA_FK_I on RWE_PLUGIN (ENTIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_PROPIE_ENTIDA_FK_I on RWE_PROPIEDADGLOBAL (ENTIDAD) TABLESPACE REGWEB_INDEX;
    create
index RWE_REGMIG_FECREG_I on RWE_REGISTRO_MIGRADO (FECHAREG) TABLESPACE REGWEB_INDEX;
    create
index RWE_REGMIG_CODOF_I on RWE_REGISTRO_MIGRADO (CODOFICINA) TABLESPACE REGWEB_INDEX;
    create
index RWE_REGMIG_EXTR_I on RWE_REGISTRO_MIGRADO (EXTRACTO) TABLESPACE REGWEB_INDEX;
    create
index RWE_REGMIG_NUM_I on RWE_REGISTRO_MIGRADO (NUMERO) TABLESPACE REGWEB_INDEX;
    create
index RWE_REGMIG_REMDES_I on RWE_REGISTRO_MIGRADO (DESREMDES) TABLESPACE REGWEB_INDEX;
    create
index RWE_REGMIG_ANO_I on RWE_REGISTRO_MIGRADO (ANO) TABLESPACE REGWEB_INDEX;
    create
index RWE_REGMIG_TREG_I on RWE_REGISTRO_MIGRADO (TREGISTRO) TABLESPACE REGWEB_INDEX;
    create
index RWE_SESION_USUENT_FK_I on RWE_SESION (USUARIO) TABLESPACE REGWEB_INDEX;
 -- FINAL Indexes

 -- INICI PK's
alter table RWE_ANEXO
    add constraint RWE_ANEXO_pk primary key (ID);

alter table RWE_ANEXO_SIR
    add constraint RWE_ANEXO_SIR_pk primary key (ID);

alter table RWE_ARCHIVO
    add constraint RWE_ARCHIVO_pk primary key (ID);

alter table RWE_CATCOMUNIDADAUTONOMA
    add constraint RWE_CATCOMUNIDADAUTONOMA_pk primary key (ID);

alter table RWE_CATENTIDADGEOGRAFICA
    add constraint RWE_CATENTIDADGEOGRAFICA_pk primary key (ID);

alter table RWE_CATESTADOENTIDAD
    add constraint RWE_CATESTADOENTIDAD_pk primary key (ID);

alter table RWE_CATLOCALIDAD
    add constraint RWE_CATLOCALIDAD_pk primary key (ID);

alter table RWE_CATNIVELADMINISTRACION
    add constraint RWE_CATNIVELADMINISTRACION_pk primary key (ID);

alter table RWE_CATPAIS
    add constraint RWE_CATPAIS_pk primary key (ID);

alter table RWE_CATPROVINCIA
    add constraint RWE_CATPROVINCIA_pk primary key (ID);

alter table RWE_CATSERVICIO
    add constraint RWE_CATSERVICIO_pk primary key (ID);

alter table RWE_CATTIPOVIA
    add constraint RWE_CATTIPOVIA_pk primary key (ID);

alter table RWE_CODIGOASUNTO
    add constraint RWE_CODIGOASUNTO_pk primary key (ID);

alter table RWE_COLA
    add constraint RWE_COLA_pk primary key (ID);

alter table RWE_CONFIGURACION
    add constraint RWE_CONFIGURACION_pk primary key (ID);

alter table RWE_CONTADOR
    add constraint RWE_CONTADOR_pk primary key (ID);

alter table RWE_DESCARGA
    add constraint RWE_DESCARGA_pk primary key (ID);

alter table RWE_ENTIDAD
    add constraint RWE_ENTIDAD_pk primary key (ID);

alter table RWE_ENTIDAD_USUENT
    add constraint RWE_ENTIDAD_USUENT_pk primary key (IDENTIDAD, IDUSUENT);

alter table RWE_HISTORICOUO
    add constraint RWE_HISTORICOUO_pk primary key (CODANTERIOR, CODULTIMA);

alter table RWE_HISTORICO_REGISTRO_ENTRADA
    add constraint RWE_HIST_REGISTRO_ENTRADA_PK primary key (ID);

alter table RWE_HISTORICO_REGISTRO_SALIDA
    add constraint RWE_HIST_REGISTRO_SALIDA_PK primary key (ID);

alter table RWE_INTEGRACION
    add constraint RWE_INTEGRACION_pk primary key (ID);

alter table RWE_INTERESADO
    add constraint RWE_INTERESADO_pk primary key (ID);

alter table RWE_INTERESADO_SIR
    add constraint RWE_INTERESADO_SIR_pk primary key (ID);

alter table RWE_LIBRO
    add constraint RWE_LIBRO_pk primary key (ID);

alter table RWE_LOPD
    add constraint RWE_LOPD_pk primary key (ID);

alter table RWE_MENSAJE_CONTROL
    add constraint RWE_MENSAJE_CONTROL_pk primary key (ID);

alter table RWE_MODELO_OFICIO_REMISION
    add constraint RWE_MODELO_OFICIO_REMISION_pk primary key (ID);

alter table RWE_MODELO_RECIBO
    add constraint RWE_MODELO_RECIBO_pk primary key (ID);

alter table RWE_MODIFICACIONLOPD_MIGRADO
    add constraint RWE_MODIFLOPD_MIGRADO_PK primary key (ID);

alter table RWE_NOTIFICACION
    add constraint RWE_NOTIFICACION_pk primary key (ID);

alter table RWE_OFICINA
    add constraint RWE_OFICINA_pk primary key (ID);

alter table RWE_OFICINA_SERVICIO
    add constraint RWE_OFICINA_SERVICIO_pk primary key (IDOFICINA, IDSERVICIO);

alter table RWE_OFICIO_REMISION
    add constraint RWE_OFICIO_REMISION_pk primary key (ID);

alter table RWE_ORGANISMO
    add constraint RWE_ORGANISMO_pk primary key (ID);

alter table RWE_PENDIENTE
    add constraint RWE_PENDIENTE_pk primary key (ID);

alter table RWE_PERMLIBUSU
    add constraint RWE_PERMLIBUSU_pk primary key (ID);

alter table RWE_PERMORGUSU
    add constraint RWE_PERMORGUSU_pk primary key (ID);

alter table RWE_PERSONA
    add constraint RWE_PERSONA_pk primary key (ID);

alter table RWE_PLUGIN
    add constraint RWE_PLUGIN_pk primary key (ID);

alter table RWE_PROPIEDADGLOBAL
    add constraint RWE_PROPIEDADGLOBAL_pk primary key (ID);

alter table RWE_REGISTROLOPD_MIGRADO
    add constraint RWE_REGISTROLOPD_MIGRADO_pk primary key (ID);

alter table RWE_REGISTRO_DETALLE
    add constraint RWE_REGISTRO_DETALLE_pk primary key (ID);

alter table RWE_REGISTRO_ENTRADA
    add constraint RWE_REGISTRO_ENTRADA_pk primary key (ID);

alter table RWE_REGISTRO_MIGRADO
    add constraint RWE_REGISTRO_MIGRADO_pk primary key (ID);

alter table RWE_REGISTRO_SALIDA
    add constraint RWE_REGISTRO_SALIDA_pk primary key (ID);

alter table RWE_REGISTRO_SIR
    add constraint RWE_REGISTRO_SIR_pk primary key (ID);

alter table RWE_RELORGOFI
    add constraint RWE_RELORGOFI_pk primary key (IDORGANISMO, IDOFICINA);

alter table RWE_RELSIROFI
    add constraint RWE_RELSIROFI_pk primary key (IDORGANISMO, IDOFICINA);

alter table RWE_REPRO
    add constraint RWE_REPRO_pk primary key (ID);

alter table RWE_ROL
    add constraint RWE_ROL_pk primary key (ID);

alter table RWE_SESION
    add constraint RWE_SESION_pk primary key (ID);

alter table RWE_TIPOASUNTO
    add constraint RWE_TIPOASUNTO_pk primary key (ID);

alter table RWE_TIPODOCUMENTAL
    add constraint RWE_TIPODOCUMENTAL_pk primary key (ID);

alter table RWE_TRAZABILIDAD
    add constraint RWE_TRAZABILIDAD_pk primary key (ID);

alter table RWE_TRAZABILIDAD_SIR
    add constraint RWE_TRAZABILIDAD_SIR_pk primary key (ID);

alter table RWE_TRA_CODIGOASUNTO
    add constraint RWE_TRA_CODIGOASUNTO_pk primary key (IDCODIGOASUNTO, LANG);

alter table RWE_TRA_TDOCUMENTAL
    add constraint RWE_TRA_TDOCUMENTAL_pk primary key (IDTDOCUMENTAL, LANG);

alter table RWE_TRA_TIPOASUNTO
    add constraint RWE_TRA_TIPOASUNTO_pk primary key (IDTIPOASUNTO, LANG);

alter table RWE_USUARIO
    add constraint RWE_USUARIO_pk primary key (ID);

alter table RWE_USUARIO_ENTIDAD
    add constraint RWE_USUARIO_ENTIDAD_pk primary key (ID);
...
-- INICI LOBS
alter table RWE_ANEXO move lob (FIRMA) store as RWE_ANEXO_FIRMA_lob (tablespace regweb3_lob index RWE_ANEXO_FIRMA_lob_i);
alter table RWE_ANEXO_SIR move lob (CERTIFICADO) store as RWE_ANX_SIR_CERT_lob (tablespace regweb3_lob index RWE_ANX_SIR_CERT_lob_i);
...
alter table RWE_ANEXO_SIR move lob (TIMESTAMP) store as RWE_ANX_SIR_TMST_lob (tablespace regweb3_lob index RWE_ANX_SIR_TMST_lob_i);
alter table RWE_ANEXO_SIR move lob (VAL_OCSP_CE) store as RWE_ANX_SIR_VALOCSP_lob (tablespace regweb3_lob index RWE_ANX_SIR_VALOCSP_lob_i);
...
alter table RWE_INTEGRACION move lob (ERROR) store as RWE_INTEGR_ERROR_lob (tablespace regweb3_lob index RWE_INTEGR_ERROR_lob_i);
alter table RWE_INTEGRACION move lob (EXCEPCION) store as RWE_INTEGR_EXCP_lob (tablespace regweb3_lob index RWE_INTEGR_EXCP_lob_i);
alter table RWE_PLUGIN move lob (PROPIEDADES_ADMIN) store as RWE_PLUGIN_PROP_ADM_lob (tablespace regweb3_lob index RWE_PLUGIN_PROP_ADM_lob_i);
alter table RWE_PLUGIN move lob (PROPIEDADES_ENTIDAD) store as RWE_PLUGIN_PROP_ENT_lob (tablespace regweb3_lob index RWE_PLUGIN_PROP_ENT_lob_i);
alter table RWE_REGISTRO_DETALLE move lob (EXPONE) store as RWE_REG_DET_EXPONE_lob (tablespace regweb3_lob index RWE_REG_DET_EXPONE_lob_i);
alter table RWE_REGISTRO_DETALLE move lob (SOLICITA) store as RWE_REG_DET_SOLICITA_lob (tablespace regweb3_lob index RWE_REG_DET_SOLICITA_lob_i);
alter table RWE_REGISTRO_SIR move lob (EXPONE) store as RWE_REGISTRO_SIR_EXPONE_lob (tablespace regweb3_lob index RWE_REGISTRO_SIR_EXPONE_lob_i);
alter table RWE_REGISTRO_SIR move lob (SOLICITA) store as RWE_REGISTRO_SIR_SOLICITA_lob (tablespace regweb3_lob index RWE_REGISTRO_SIR_SOLICITA_lob_i);
alter table RWE_REGISTRO_SIR move lob (TIMESTAMP) store as RWE_REG_SIR_TMST_lob (tablespace regweb3_lob index RWE_REG_SIR_TMST_lob_i);
