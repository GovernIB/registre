...
alter table RWE_CODIGOASUNTO add constraint URWE_CODASUN_CODIGO_UK unique (CODIGO);

alter table RWE_ENTIDAD add constraint RWE_ENTIDAD_CODIGODIR3_UK unique (CODIGODIR3);

alter table RWE_PERSONA add constraint UK_PERSONA_DOCUMENTO_UK unique (DOCUMENTO);
