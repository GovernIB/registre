...
ALTER TABLE RWE_USUARIO_ENTIDAD add (externo number(1,0) DEFAULT 0 not null);

-- Índices RWE_REGISTRO_SIR
CREATE INDEX RWE_REGISTRO_CER_FK_I on RWE_REGISTRO_SIR (COD_ENT_REG) TABLESPACE REGWEB_INDEX;
CREATE INDEX RWE_REGISTRO_ESTADO_FK_I on RWE_REGISTRO_SIR (ESTADO) TABLESPACE REGWEB_INDEX;

-- Índice RWE_INTERESADO_SIR
CREATE INDEX RWE_INTERESADOSIR_REGSIR_FK_I on RWE_INTERESADO_SIR (REGISTRO_SIR) TABLESPACE REGWEB_INDEX;
