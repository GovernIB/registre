 ...
 -- INICI GRANTS
    ...
    grant select,insert,delete,update on RWE_IDIOMA to www_regweb;
    grant select,insert,delete,update on RWE_IDIOMA_REGISTRO to www_regweb;
    ...
    grant select,insert,delete,update on RWE_PRE_REGISTRO to www_regweb;
