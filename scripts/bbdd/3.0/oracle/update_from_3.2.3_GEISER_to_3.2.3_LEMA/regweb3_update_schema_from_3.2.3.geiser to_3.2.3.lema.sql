...
(
    ...
    CONCEPTO					VARCHAR2(1000 CHAR) NOT NULL,
    DESCRIPCION					VARCHAR2(1000 CHAR),
    IDENTIFICADOR				VARCHAR2(255 CHAR),
    CODIGO_ORIGEN 				NUMBER(19,0),
    TIPO						NUMBER(1) NOT NULL,
    ORGANO_EMISOR_CODIGO    	VARCHAR2(9 CHAR) NOT NULL,
    ORGANO_EMISOR_NIF 			VARCHAR2(9 CHAR),
    ORGANO_EMISOR_NOMBRE		VARCHAR2(512 CHAR) NOT NULL,
    FECHA_PUESTA_DISPOSICION	DATE,
    TITULAR_NIF					VARCHAR2(9 CHAR),
    TITULAR_NOMBRE				VARCHAR2(512 CHAR),
    ENTIDAD_CODIGO				VARCHAR2(9),
    ENTIDAD_NOMBRE				VARCHAR2(255),
    ESTADO						VARCHAR2(64 CHAR) NOT NULL,
    ESTADO_NOTIFICA				VARCHAR2(64 CHAR) NOT NULL,
    CODIGO_PROCEDIMIENTO		VARCHAR2(255 CHAR),
