...
ALTER TABLE RWE_OFICIO_REMISION add CONTACTOSDESTINO varchar2(2000 char);
ALTER TABLE RWE_OFICIO_REMISION add COD_ENT_REG_PROC varchar2(21 char);
ALTER TABLE RWE_OFICIO_REMISION add DEC_ENT_REG_PROC varchar2(80 char);
