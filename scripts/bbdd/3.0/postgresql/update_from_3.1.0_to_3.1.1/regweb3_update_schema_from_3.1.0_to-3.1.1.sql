...
ALTER TABLE RWE_USUARIO add RWE_WS_ENTRADA int8 DEFAULT 0 not null;
ALTER TABLE RWE_USUARIO add RWE_WS_SALIDA int8 DEFAULT 0 not null;
ALTER TABLE RWE_USUARIO add RWE_WS_CIUDADANO int8 DEFAULT 0 not null;
