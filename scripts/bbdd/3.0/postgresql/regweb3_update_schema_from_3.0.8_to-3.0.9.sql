...
INSERT INTO rwe_propiedadglobal(id,clave,valor,tipo,descripcion,entidad) SELECT nextval('RWE_ALL_SEQ'), 'es.caib.regweb3.justificante.plugin','org.fundaciobit.plugins.justificante.caib.CaibJustificantePlugin',1,'Plugin de justificante CAIB',id FROM rwe_entidad;
