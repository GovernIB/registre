...
ALTER TABLE RWE_ASIENTO_REGISTRAL_SIR add REINTENTOS int4 DEFAULT 0;
ALTER TABLE RWE_ASIENTO_REGISTRAL_SIR add COD_ERROR varchar(255);
ALTER TABLE RWE_ASIENTO_REGISTRAL_SIR add DESC_ERROR varchar(2000);
