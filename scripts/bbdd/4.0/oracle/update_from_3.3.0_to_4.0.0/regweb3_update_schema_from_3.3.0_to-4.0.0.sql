...
ALTER TABLE RWE_ANEXO MODIFY OBSERVACIONES varchar2(160 char);

--Cambio tamanyo RWE_ANEXO_SIR
ALTER TABLE RWE_ANEXO_SIR MODIFY OBSERVACIONES varchar2(160 char);
ALTER TABLE RWE_ANEXO_SIR MODIFY TIPO_MIME varchar2(80 char);
...
ALTER TABLE RWE_REGISTRO_DETALLE MODIFY OFICINAEXTERNO varchar2(21 char);
...
-- Modificación de campo DOCUMENTO en RWE_INTERESADO
...
ALTER TABLE RWE_INTERESADO_SIR MODIFY DOCUMENTO_INTERESADO VARCHAR2(256 CHAR);
ALTER TABLE RWE_INTERESADO_SIR MODIFY DOCUMENTO_REPRESENTANTE VARCHAR2(256 CHAR);
...
ALTER TABLE RWE_ANEXO_SIR ADD FIRMA_BASE64 RAW(2000);
...
ALTER TABLE RWE_REGISTRO_ENTRADA MODIFY DESTEXTCOD varchar2(21 char);
ALTER TABLE RWE_REGISTRO_SALIDA MODIFY DESTEXTCOD varchar2(21 char);
ALTER TABLE RWE_OFICIO_REMISION MODIFY DESTINOEXTERNOCODIGO varchar2(21 char);
