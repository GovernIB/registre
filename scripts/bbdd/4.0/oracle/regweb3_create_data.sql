...
es.caib.regweb3.pluginsib.userinformation.database.name_column=USU_NOM
es.caib.regweb3.pluginsib.userinformation.database.userroles_table=SC_WL_USUGRU
es.caib.regweb3.pluginsib.userinformation.database.userroles_rolename_column=UGR_CODGRU
es.caib.regweb3.pluginsib.userinformation.database.userroles_username_column=UGR_CODUSU');
