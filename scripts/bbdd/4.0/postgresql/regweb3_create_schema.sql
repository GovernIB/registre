...
create sequence RWE_SIR_SEQ start 1 increment 1;
    ...
    create table RWE_ENTIDAD (
       ID int8 not null,
        ...
        OFICIOREMISION boolean not null,
        PERFIL_CUSTODIA int8,
        POSXSELLO int4,
        POSYSELLO int4,
        SELLO varchar(4000),
    ...
    create table RWE_INTERESADO (
       ID int8 not null,
        ...
        AVISONOTIFEMAIL boolean,
        AVISONOTIFSMS boolean,
        CANALNOTIF int8,
        DIRUNIFICADO varchar(21),
    ...
    create table RWE_REGISTRO_DETALLE (
       ID int8 not null,
        ...
        COD_ENT_REG_DEST varchar(21),
        CODIGOSIA int8,
        COD_UNITRAM_INICIO varchar(21),
        DEC_ENT_REG_DEST varchar(120),
        DEC_T_ANOTACION varchar(160),
        DEC_UNITRAM_INICIO varchar(120),
        ...
        ID_INTERCAMBIO varchar(33),
        IDINTERCAMBIO_PREVIO varchar(33),
        IDIOMA int8,
        INDICADOR_PRUEBA int4,
        NUMREG_ORIGEN varchar(20),
        NUMTRANSPORTE varchar(40),
        OBSERVACIONES varchar(160),
        ...
        SOLICITA text,
        TIMESTAMP_PRES_INTER varchar(255),
        TIPO_ANOTACION varchar(2),
        TIPODOCFISICA int8,
    ...
    create table RWE_REGISTRO_SIR (
       ID int8 not null,
        ...
        DEC_ENT_REG_DEST varchar(120),
        DEC_ENT_REG_INI varchar(120),
        DEC_ENT_REG_ORI varchar(120),
        DEC_T_ANOTACION varchar(80),
        DEC_UNI_TRA_DEST varchar(120),
        DEC_UNI_TRA_ORI varchar(120),
        DESC_ERROR varchar(2000),
