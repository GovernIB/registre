 ...
 */
@Embeddable
public class LogSalidaLopdId implements java.io.Serializable {
	...
	public LogSalidaLopdId() {
	}

	public LogSalidaLopdId(String tipoAcceso, String usuario, int fecha,
	...
	@Column(name = "FZUTIPAC", nullable = false, length = 10)
	...
	@Column(name = "FZUCUSU", nullable = false, length = 10)
	...
	@Column(name = "FZUDATAC", nullable = false, precision = 8, scale = 0)
	public int getFecha() {
		return this.fecha;
	}
	...
	@Column(name = "FZUHORAC", nullable = false, precision = 9, scale = 0)
	public int getHora() {
		return this.hora;
	}
	...
	@Column(name = "FZUNUMEN", nullable = false, precision = 5, scale = 0)
	...
	@Column(name = "FZUANOEN", nullable = false, precision = 4, scale = 0)
	public int getAnyo() {
		return this.anyo;
	}
	...
	@Column(name = "FZUCAGCO", nullable = false, precision = 2, scale = 0)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LogSalidaLopdId))
			return false;
		LogSalidaLopdId castOther = (LogSalidaLopdId) other;
