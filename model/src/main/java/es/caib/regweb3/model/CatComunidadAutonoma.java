...
@org.hibernate.annotations.Table(appliesTo = "RWE_CATCOMUNIDADAUTONOMA", indexes = {
        @Index(name = "RWE_CATCOM_CATPAI_FK_I", columnNames = {"PAIS"})
})
...
public class CatComunidadAutonoma implements Serializable {
    ...
    @ForeignKey(name = "RWE_CATCOMUNAUT_CATPAIS_FK")
