 ...
 */
@Entity
@Table(name = "RWE_CATLOCALIDAD", indexes = {
        @Index(name = "RWE_CATLOC_CATPRO_FK_I", columnList = "PROVINCIA"),
        @Index(name = "RWE_CATLOC_CATENG_FK_I", columnList = "ENTIDADGEOGRAFICA")})
