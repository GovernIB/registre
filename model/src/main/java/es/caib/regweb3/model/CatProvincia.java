 ...
 */
@Table(name = "RWE_CATPROVINCIA")
@org.hibernate.annotations.Table(appliesTo = "RWE_CATPROVINCIA", indexes = {
        @Index(name = "RWE_CATPRO_CATCAU_FK_I", columnNames = {"COMUNIDADAUTONOMA"})
})
@Entity
...
public class CatProvincia implements Serializable {
    ...
    @ForeignKey(name = "RWE_CATPROVINC_CATCOMUNAUTO_FK")
    @JsonIgnore
