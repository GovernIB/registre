...
public class ListaErroresSalida  implements java.io.Serializable {
    private es.caib.regweb.ws.services.regwebfacade.ErrorSalida[] errores;

    public ListaErroresSalida() {
    }

    public ListaErroresSalida(
           es.caib.regweb.ws.services.regwebfacade.ErrorSalida[] errores) {
     ...
     * @return errores
     */
    public es.caib.regweb.ws.services.regwebfacade.ErrorSalida[] getErrores() {
        return errores;
    }
     ...
     * @param errores
     */
    public void setErrores(es.caib.regweb.ws.services.regwebfacade.ErrorSalida[] errores) {
        this.errores = errores;
    }

    public es.caib.regweb.ws.services.regwebfacade.ErrorSalida getErrores(int i) {
        return this.errores[i];
    }

    public void setErrores(int i, es.caib.regweb.ws.services.regwebfacade.ErrorSalida _value) {
