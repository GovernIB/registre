...
public class RegwebFacadeServiceLocator extends org.apache.axis.client.Service implements es.caib.regweb.ws.services.regwebfacade.RegwebFacadeService {
    ...
    public es.caib.regweb.ws.services.regwebfacade.RegwebFacade_PortType getRegwebFacade(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.caib.regweb.ws.services.regwebfacade.RegwebFacadeSoapBindingStub _stub = new es.caib.regweb.ws.services.regwebfacade.RegwebFacadeSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.caib.regweb.ws.services.regwebfacade.RegwebFacade_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.caib.regweb.ws.services.regwebfacade.RegwebFacadeSoapBindingStub _stub = new es.caib.regweb.ws.services.regwebfacade.RegwebFacadeSoapBindingStub(new java.net.URL(RegwebFacade_address), this);
                _stub.setPortName(getRegwebFacadeWSDDServiceName());
                return _stub;
            }
        }
