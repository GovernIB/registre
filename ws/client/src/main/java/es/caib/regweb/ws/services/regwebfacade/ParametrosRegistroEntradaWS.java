...
public class ParametrosRegistroEntradaWS  implements java.io.Serializable {
    ...
    private es.caib.regweb.ws.services.regwebfacade.ParametrosRegistroPublicadoEntradaWS paramRegPubEnt;
    ...
    private es.caib.regweb.ws.services.regwebfacade.ListaErroresEntrada errores;
    ...
    public ParametrosRegistroEntradaWS(
           ...
           es.caib.regweb.ws.services.regwebfacade.ParametrosRegistroPublicadoEntradaWS paramRegPubEnt,
     ...
     */
    public es.caib.regweb.ws.services.regwebfacade.ParametrosRegistroPublicadoEntradaWS getParamRegPubEnt() {
        return paramRegPubEnt;
    }
     ...
     */
    public void setParamRegPubEnt(es.caib.regweb.ws.services.regwebfacade.ParametrosRegistroPublicadoEntradaWS paramRegPubEnt) {
        this.paramRegPubEnt = paramRegPubEnt;
    }
     ...
     * @return errores
     */
    public es.caib.regweb.ws.services.regwebfacade.ListaErroresEntrada getErrores() {
        return errores;
    }
     ...
     * @param errores
     */
    public void setErrores(es.caib.regweb.ws.services.regwebfacade.ListaErroresEntrada errores) {
        this.errores = errores;
    }
