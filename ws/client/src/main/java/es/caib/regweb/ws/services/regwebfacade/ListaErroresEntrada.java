...
public class ListaErroresEntrada  implements java.io.Serializable {
    private es.caib.regweb.ws.services.regwebfacade.ErrorEntrada[] errores;

    public ListaErroresEntrada() {
    }

    public ListaErroresEntrada(
           es.caib.regweb.ws.services.regwebfacade.ErrorEntrada[] errores) {
     ...
     * @return errores
     */
    public es.caib.regweb.ws.services.regwebfacade.ErrorEntrada[] getErrores() {
        return errores;
    }
     ...
     * @param errores
     */
    public void setErrores(es.caib.regweb.ws.services.regwebfacade.ErrorEntrada[] errores) {
        this.errores = errores;
    }

    public es.caib.regweb.ws.services.regwebfacade.ErrorEntrada getErrores(int i) {
        return this.errores[i];
    }

    public void setErrores(int i, es.caib.regweb.ws.services.regwebfacade.ErrorEntrada _value) {
