...
public class ParametrosRegistroSalidaWS  implements java.io.Serializable {
    ...
    private es.caib.regweb.ws.model.ListaErroresSalida errores;
    ...
    public ParametrosRegistroSalidaWS(
           ...
           es.caib.regweb.ws.model.ListaErroresSalida errores) {
     ...
     * @return errores
     */
    public es.caib.regweb.ws.model.ListaErroresSalida getErrores() {
        return errores;
    }
     ...
     * @param errores
     */
    public void setErrores(es.caib.regweb.ws.model.ListaErroresSalida errores) {
        this.errores = errores;
    }
