...
public class ListaErroresSalida  implements java.io.Serializable {
    private es.caib.regweb.ws.model.ErrorSalida[] errores;

    public ListaErroresSalida() {
    }

    public ListaErroresSalida(
           es.caib.regweb.ws.model.ErrorSalida[] errores) {
     ...
     * @return errores
     */
    public es.caib.regweb.ws.model.ErrorSalida[] getErrores() {
        return errores;
    }
     ...
     * @param errores
     */
    public void setErrores(es.caib.regweb.ws.model.ErrorSalida[] errores) {
        this.errores = errores;
    }

    public es.caib.regweb.ws.model.ErrorSalida getErrores(int i) {
        return this.errores[i];
    }

    public void setErrores(int i, es.caib.regweb.ws.model.ErrorSalida _value) {
