...
public class ListaErroresEntrada  implements java.io.Serializable {
    private es.caib.regweb.ws.model.ErrorEntrada[] errores;

    public ListaErroresEntrada() {
    }

    public ListaErroresEntrada(
           es.caib.regweb.ws.model.ErrorEntrada[] errores) {
     ...
     * @return errores
     */
    public es.caib.regweb.ws.model.ErrorEntrada[] getErrores() {
        return errores;
    }
     ...
     * @param errores
     */
    public void setErrores(es.caib.regweb.ws.model.ErrorEntrada[] errores) {
        this.errores = errores;
    }

    public es.caib.regweb.ws.model.ErrorEntrada getErrores(int i) {
        return this.errores[i];
    }

    public void setErrores(int i, es.caib.regweb.ws.model.ErrorEntrada _value) {
