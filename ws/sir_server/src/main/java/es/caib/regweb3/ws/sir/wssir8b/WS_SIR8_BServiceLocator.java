...
public class WS_SIR8_BServiceLocator extends org.apache.axis.client.Service implements es.caib.regweb3.ws.sir.wssir8b.WS_SIR8_BService {
    ...
    public es.caib.regweb3.ws.sir.wssir8b.WS_SIR8_B_PortType getWS_SIR8_B() throws javax.xml.rpc.ServiceException {
    ...
    public es.caib.regweb3.ws.sir.wssir8b.WS_SIR8_B_PortType getWS_SIR8_B(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.caib.regweb3.ws.sir.wssir8b.WS_SIR8_BSoapBindingStub _stub = new es.caib.regweb3.ws.sir.wssir8b.WS_SIR8_BSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.caib.regweb3.ws.sir.wssir8b.WS_SIR8_B_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.caib.regweb3.ws.sir.wssir8b.WS_SIR8_BSoapBindingStub _stub = new es.caib.regweb3.ws.sir.wssir8b.WS_SIR8_BSoapBindingStub(new java.net.URL(WS_SIR8_B_address), this);
                _stub.setPortName(getWS_SIR8_BWSDDServiceName());
                return _stub;
            }
        }
