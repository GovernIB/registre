package es.caib.regweb.ws.api.v3.utils;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import es.caib.regweb.ws.api.v3.WsFieldValidationError;
import es.caib.regweb.ws.api.v3.WsI18NArgument;
import es.caib.regweb.ws.api.v3.WsI18NError;
import es.caib.regweb.ws.api.v3.WsI18NException;
import es.caib.regweb.ws.api.v3.WsI18NTranslation;
