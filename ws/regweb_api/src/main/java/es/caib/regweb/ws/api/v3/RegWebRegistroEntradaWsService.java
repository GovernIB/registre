...
@WebServiceClient(name = "RegWebRegistroEntradaWsService", 
                  ...
                  targetNamespace = "http://registroentrada.impl.v3.ws.regweb.caib.es/") 
public class RegWebRegistroEntradaWsService extends Service {

    public final static URL WSDL_LOCATION;
    public final static QName SERVICE = new QName("http://registroentrada.impl.v3.ws.regweb.caib.es/", "RegWebRegistroEntradaWsService");
    public final static QName RegWebRegistroEntradaWs = new QName("http://registroentrada.impl.v3.ws.regweb.caib.es/", "RegWebRegistroEntradaWs");
    static {
        URL url = null;
        try {
