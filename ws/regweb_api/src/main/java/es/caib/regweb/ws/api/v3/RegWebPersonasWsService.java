...
public class RegWebPersonasWsService extends Service {
    ...
    public final static QName SERVICE = new QName("http://impl.v3.ws.regweb.caib.es/", "RegWebPersonasWsService");
    public final static QName RegWebPersonasWs = new QName("http://impl.v3.ws.regweb.caib.es/", "RegWebPersonasWs");
    static {
        URL url = null;
        try {
