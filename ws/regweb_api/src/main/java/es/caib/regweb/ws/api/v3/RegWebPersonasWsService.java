...
@WebServiceClient(name = "RegWebPersonasWsService", 
                  wsdlLocation = "http://localhost:8080/regweb/ws/v3/RegWebPersonas?wsdl",
                  targetNamespace = "http://personas.impl.v3.ws.regweb.caib.es/") 
public class RegWebPersonasWsService extends Service {

    public final static URL WSDL_LOCATION;
    public final static QName SERVICE = new QName("http://personas.impl.v3.ws.regweb.caib.es/", "RegWebPersonasWsService");
    public final static QName RegWebPersonasWs = new QName("http://personas.impl.v3.ws.regweb.caib.es/", "RegWebPersonasWs");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/regweb/ws/v3/RegWebPersonas?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://localhost:8080/regweb/ws/v3/RegWebPersonas?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
