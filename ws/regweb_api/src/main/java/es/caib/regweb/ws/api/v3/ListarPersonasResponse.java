 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://personas.impl.v3.ws.regweb.caib.es/}personaWs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ListarPersonasResponse {
    ...
    protected List<PersonaWs> _return;
     ...
     * 
     */
    public List<PersonaWs> getReturn() {
        if (_return == null) {
            _return = new ArrayList<PersonaWs>();
        }
        return this._return;
    }
