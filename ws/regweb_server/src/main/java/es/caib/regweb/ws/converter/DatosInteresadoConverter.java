...
import es.caib.regweb.ws.model.DatosInteresadoWs;
...
public class DatosInteresadoConverter extends CommonConverter {
    ...
    /**
     * Convierte un {@link es.caib.regweb.ws.model.DatosInteresadoWs} en un {@link es.caib.regweb.model.Interesado}
    ...
    /**
     * Convierte un {@link es.caib.regweb.model.Interesado} en un {@link es.caib.regweb.ws.model.InteresadoWs}
     * @param interesado
     * @return
     * @throws Exception
     * @throws I18NException
    ...
    /**
     * Convierte un {@link es.caib.regweb.model.Interesado} en un {@link es.caib.regweb.ws.model.DatosInteresadoWs}
     * @param interesado
     * @return
     * @throws Exception
     */
    private static DatosInteresadoWs procesarDatosInteresadoWs(Interesado interesado) throws Exception{
        ...
        if(interesado.getTipoDocumentoIdentificacion() != null) {
            datosInteresadoWs.setTipoDocumentoIdentificacion(RegwebConstantes.CODIGO_NTI_BY_TIPODOCUMENTOID.get(interesado.getTipoDocumentoIdentificacion()));
        }
