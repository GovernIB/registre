...
public class RegWebHelloWorldWithSecurityWsServiceLocator extends org.apache.axis.client.Service implements es.caib.regweb.ws.v3.apiaxis.RegWebHelloWorldWithSecurityWsService {
    ...
    public es.caib.regweb.ws.v3.apiaxis.RegWebHelloWorldWithSecurityWs_PortType getRegWebHelloWorldWithSecurityWs() throws javax.xml.rpc.ServiceException {
    ...
    public es.caib.regweb.ws.v3.apiaxis.RegWebHelloWorldWithSecurityWs_PortType getRegWebHelloWorldWithSecurityWs(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.caib.regweb.ws.v3.apiaxis.RegWebHelloWorldWithSecurityWsServiceSoapBindingStub _stub = new es.caib.regweb.ws.v3.apiaxis.RegWebHelloWorldWithSecurityWsServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.caib.regweb.ws.v3.apiaxis.RegWebHelloWorldWithSecurityWs_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.caib.regweb.ws.v3.apiaxis.RegWebHelloWorldWithSecurityWsServiceSoapBindingStub _stub = new es.caib.regweb.ws.v3.apiaxis.RegWebHelloWorldWithSecurityWsServiceSoapBindingStub(new java.net.URL(RegWebHelloWorldWithSecurityWs_address), this);
                _stub.setPortName(getRegWebHelloWorldWithSecurityWsWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.v3.ws.regweb.caib.es/", "RegWebHelloWorldWithSecurityWsService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.v3.ws.regweb.caib.es/", "RegWebHelloWorldWithSecurityWs"));
        }
