...
public class RegWebPersonasWsServiceSoapBindingStub extends org.apache.axis.client.Stub implements es.caib.regweb.ws.v3.apiaxis.RegWebPersonasWs_PortType {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {entidadCodigoDir3});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (es.caib.regweb.ws.v3.apiaxis.PersonaWs[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (es.caib.regweb.ws.v3.apiaxis.PersonaWs[]) org.apache.axis.utils.JavaUtils.convert(_resp, es.caib.regweb.ws.v3.apiaxis.PersonaWs[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
