...
public class LibroOficinaWs  implements java.io.Serializable {
    private es.caib.regweb.ws.v3.apiaxis.LibroWs libroWs;

    private es.caib.regweb.ws.v3.apiaxis.OficinaWs oficinaWs;

    public LibroOficinaWs() {
    }

    public LibroOficinaWs(
           es.caib.regweb.ws.v3.apiaxis.LibroWs libroWs,
           es.caib.regweb.ws.v3.apiaxis.OficinaWs oficinaWs) {
     ...
     * @return libroWs
     */
    public es.caib.regweb.ws.v3.apiaxis.LibroWs getLibroWs() {
        return libroWs;
    }
     ...
     * @param libroWs
     */
    public void setLibroWs(es.caib.regweb.ws.v3.apiaxis.LibroWs libroWs) {
        this.libroWs = libroWs;
    }
     ...
     * @return oficinaWs
     */
    public es.caib.regweb.ws.v3.apiaxis.OficinaWs getOficinaWs() {
        return oficinaWs;
    }
     ...
     * @param oficinaWs
     */
    public void setOficinaWs(es.caib.regweb.ws.v3.apiaxis.OficinaWs oficinaWs) {
        this.oficinaWs = oficinaWs;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.v3.ws.regweb.caib.es/", "libroOficinaWs"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("libroWs");
        elemField.setXmlName(new javax.xml.namespace.QName("", "libroWs"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://impl.v3.ws.regweb.caib.es/", "libroWs"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://impl.v3.ws.regweb.caib.es/", "oficinaWs"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
