...
public class CodigoAsuntoWs  implements java.io.Serializable {
    ...
    private es.caib.regweb.ws.v3.apiaxis.TipoAsuntoWs tipoAsunto;
    ...
    public CodigoAsuntoWs(
           ...
           es.caib.regweb.ws.v3.apiaxis.TipoAsuntoWs tipoAsunto) {
           this.codigo = codigo;
           this.nombre = nombre;
     ...
     * @return tipoAsunto
     */
    public es.caib.regweb.ws.v3.apiaxis.TipoAsuntoWs getTipoAsunto() {
        return tipoAsunto;
    }
     ...
     * @param tipoAsunto
     */
    public void setTipoAsunto(es.caib.regweb.ws.v3.apiaxis.TipoAsuntoWs tipoAsunto) {
        this.tipoAsunto = tipoAsunto;
    }
