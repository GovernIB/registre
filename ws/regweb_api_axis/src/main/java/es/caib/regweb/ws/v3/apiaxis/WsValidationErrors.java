...
public class WsValidationErrors  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    private es.caib.regweb.ws.v3.apiaxis.WsFieldValidationError[] fieldFaults;

    public WsValidationErrors() {
    }

    public WsValidationErrors(
           es.caib.regweb.ws.v3.apiaxis.WsFieldValidationError[] fieldFaults) {
     ...
     * @return fieldFaults
     */
    public es.caib.regweb.ws.v3.apiaxis.WsFieldValidationError[] getFieldFaults() {
        return fieldFaults;
    }
     ...
     * @param fieldFaults
     */
    public void setFieldFaults(es.caib.regweb.ws.v3.apiaxis.WsFieldValidationError[] fieldFaults) {
        this.fieldFaults = fieldFaults;
    }

    public es.caib.regweb.ws.v3.apiaxis.WsFieldValidationError getFieldFaults(int i) {
        return this.fieldFaults[i];
    }

    public void setFieldFaults(int i, es.caib.regweb.ws.v3.apiaxis.WsFieldValidationError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://registroentrada.impl.v3.ws.regweb.caib.es/", "WsValidationErrors"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("fieldFaults");
        elemField.setXmlName(new javax.xml.namespace.QName("", "fieldFaults"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://registroentrada.impl.v3.ws.regweb.caib.es/", "wsFieldValidationError"));
