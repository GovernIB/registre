...
public class RegWebInfoWsServiceLocator extends org.apache.axis.client.Service implements es.caib.regweb.ws.v3.apiaxis.RegWebInfoWsService {
    ...
    public es.caib.regweb.ws.v3.apiaxis.RegWebInfoWs_PortType getRegWebInfoWs() throws javax.xml.rpc.ServiceException {
    ...
    public es.caib.regweb.ws.v3.apiaxis.RegWebInfoWs_PortType getRegWebInfoWs(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.caib.regweb.ws.v3.apiaxis.RegWebInfoWsServiceSoapBindingStub _stub = new es.caib.regweb.ws.v3.apiaxis.RegWebInfoWsServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.caib.regweb.ws.v3.apiaxis.RegWebInfoWs_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.caib.regweb.ws.v3.apiaxis.RegWebInfoWsServiceSoapBindingStub _stub = new es.caib.regweb.ws.v3.apiaxis.RegWebInfoWsServiceSoapBindingStub(new java.net.URL(RegWebInfoWs_address), this);
                _stub.setPortName(getRegWebInfoWsWSDDServiceName());
                return _stub;
            }
        }
