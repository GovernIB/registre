...
public class WsI18NTranslation  implements java.io.Serializable {
    ...
    private es.caib.regweb.ws.v3.apiaxis.WsI18NArgument[] args;
    ...
    public WsI18NTranslation(
           ...
           es.caib.regweb.ws.v3.apiaxis.WsI18NArgument[] args) {
           this.code = code;
           this.args = args;
    }
     ...
     * @return args
     */
    public es.caib.regweb.ws.v3.apiaxis.WsI18NArgument[] getArgs() {
        return args;
    }
     ...
     * @param args
     */
    public void setArgs(es.caib.regweb.ws.v3.apiaxis.WsI18NArgument[] args) {
        this.args = args;
    }

    public es.caib.regweb.ws.v3.apiaxis.WsI18NArgument getArgs(int i) {
        return this.args[i];
    }

    public void setArgs(int i, es.caib.regweb.ws.v3.apiaxis.WsI18NArgument _value) {
        this.args[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://info.impl.v3.ws.regweb.caib.es/", "wsI18NTranslation"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://info.impl.v3.ws.regweb.caib.es/", "wsI18NArgument"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
