...
public class InteresadoWs  implements java.io.Serializable {
    private es.caib.regweb.ws.v3.apiaxis.DatosInteresadoWs interesado;

    private es.caib.regweb.ws.v3.apiaxis.DatosInteresadoWs representante;

    public InteresadoWs() {
    }

    public InteresadoWs(
           es.caib.regweb.ws.v3.apiaxis.DatosInteresadoWs interesado,
           es.caib.regweb.ws.v3.apiaxis.DatosInteresadoWs representante) {
     ...
     * @return interesado
     */
    public es.caib.regweb.ws.v3.apiaxis.DatosInteresadoWs getInteresado() {
        return interesado;
    }
     ...
     * @param interesado
     */
    public void setInteresado(es.caib.regweb.ws.v3.apiaxis.DatosInteresadoWs interesado) {
        this.interesado = interesado;
    }
     ...
     */
    public es.caib.regweb.ws.v3.apiaxis.DatosInteresadoWs getRepresentante() {
        return representante;
    }
     ...
     * @param representante
     */
    public void setRepresentante(es.caib.regweb.ws.v3.apiaxis.DatosInteresadoWs representante) {
        this.representante = representante;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://registrosalida.impl.v3.ws.regweb.caib.es/", "interesadoWs"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("interesado");
        elemField.setXmlName(new javax.xml.namespace.QName("", "interesado"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://registrosalida.impl.v3.ws.regweb.caib.es/", "datosInteresadoWs"));
