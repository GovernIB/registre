...
public class WS_SIR6_BServiceLocator extends org.apache.axis.client.Service implements es.caib.regweb3.ws.sir.api.wssir6b.WS_SIR6_BService {
    ...
    public es.caib.regweb3.ws.sir.api.wssir6b.WS_SIR6_B_PortType getWS_SIR6_B() throws javax.xml.rpc.ServiceException {
    ...
    public es.caib.regweb3.ws.sir.api.wssir6b.WS_SIR6_B_PortType getWS_SIR6_B(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.caib.regweb3.ws.sir.api.wssir6b.WS_SIR6_BSoapBindingStub _stub = new es.caib.regweb3.ws.sir.api.wssir6b.WS_SIR6_BSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.caib.regweb3.ws.sir.api.wssir6b.WS_SIR6_B_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.caib.regweb3.ws.sir.api.wssir6b.WS_SIR6_BSoapBindingStub _stub = new es.caib.regweb3.ws.sir.api.wssir6b.WS_SIR6_BSoapBindingStub(new java.net.URL(WS_SIR6_B_address), this);
                _stub.setPortName(getWS_SIR6_BWSDDServiceName());
                return _stub;
            }
        }
