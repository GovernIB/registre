...
public class WS_SIR7ServiceLocator extends org.apache.axis.client.Service implements es.caib.regweb.ws.sir.api.wssir7.WS_SIR7Service {
    ...
    public es.caib.regweb.ws.sir.api.wssir7.WS_SIR7_PortType getWS_SIR7() throws javax.xml.rpc.ServiceException {
    ...
    public es.caib.regweb.ws.sir.api.wssir7.WS_SIR7_PortType getWS_SIR7(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.caib.regweb.ws.sir.api.wssir7.WS_SIR7SoapBindingStub _stub = new es.caib.regweb.ws.sir.api.wssir7.WS_SIR7SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.caib.regweb.ws.sir.api.wssir7.WS_SIR7_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.caib.regweb.ws.sir.api.wssir7.WS_SIR7SoapBindingStub _stub = new es.caib.regweb.ws.sir.api.wssir7.WS_SIR7SoapBindingStub(new java.net.URL(WS_SIR7_address), this);
                _stub.setPortName(getWS_SIR7WSDDServiceName());
                return _stub;
            }
        }
