...
public class WS_SIR6_AServiceLocator extends org.apache.axis.client.Service implements es.caib.regweb.ws.sir.api.wssir6a.WS_SIR6_AService {
    ...
    public es.caib.regweb.ws.sir.api.wssir6a.WS_SIR6_A_PortType getWS_SIR6_A() throws javax.xml.rpc.ServiceException {
    ...
    public es.caib.regweb.ws.sir.api.wssir6a.WS_SIR6_A_PortType getWS_SIR6_A(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            es.caib.regweb.ws.sir.api.wssir6a.WS_SIR6_ASoapBindingStub _stub = new es.caib.regweb.ws.sir.api.wssir6a.WS_SIR6_ASoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (es.caib.regweb.ws.sir.api.wssir6a.WS_SIR6_A_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                es.caib.regweb.ws.sir.api.wssir6a.WS_SIR6_ASoapBindingStub _stub = new es.caib.regweb.ws.sir.api.wssir6a.WS_SIR6_ASoapBindingStub(new java.net.URL(WS_SIR6_A_address), this);
                _stub.setPortName(getWS_SIR6_AWSDDServiceName());
                return _stub;
            }
        }
