...
public interface AsientoRegistralWs {
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "obtenerRegistrosCiudadano", targetNamespace = "http://impl.v3.ws.regweb3.caib.es/", className = "es.caib.regweb3.ws.api.v3.ObtenerRegistrosCiudadano")
    @WebMethod
    @ResponseWrapper(localName = "obtenerRegistrosCiudadanoResponse", targetNamespace = "http://impl.v3.ws.regweb3.caib.es/", className = "es.caib.regweb3.ws.api.v3.ObtenerRegistrosCiudadanoResponse")
    public java.util.List<es.caib.regweb3.ws.api.v3.AsientoRegistralWs_Type> obtenerRegistrosCiudadano(
        @WebParam(name = "entidad", targetNamespace = "")
        java.lang.String entidad,
