package org.fundaciobit.plugins.justificante.caib;
 ...
 *
 */
public class CaibJustificantePlugin extends AbstractPluginProperties implements IJustificantePlugin {
     ...
     * @param properties
     */
    public CaibJustificantePlugin(String propertyKeyBase, Properties properties) {
     ...
     * @param propertyKeyBase
     */
    public CaibJustificantePlugin(String propertyKeyBase) {
