 ...
 *         &lt;element name="nifTitular" type="{http://administracion.gob.es/punto-unico-notificaciones/respuestaLocaliza}Nif"/>
 *         &lt;element name="codigoDIR3" type="{http://administracion.gob.es/punto-unico-notificaciones/respuestaLocaliza}CodigoOrganismo" minOccurs="0"/>
...
@XmlType(name = "Persona", namespace = "http://administracion.gob.es/punto-unico-notificaciones/respuestaLocaliza", propOrder = {
    "nombreTitular",
    "nifTitular",
    "codigoDIR3",
    "codigoDIRe",
