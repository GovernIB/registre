        ...
        if(emailsParts!=null) {
            ...
            for (String email : emailsParts) {
                ...
                String mensajeTexto = "<!DOCTYPE html><html><head><style>body {margin: 0px;font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;font-size: 14px;color: #333;}\n" +
                        ...
                        "color: black;    font-size: 30px;display: inline-block;vertical-align: middle;line-height: normal; }.footerText {    \n" +
                        "font-weight: bold;    font-family: \"Trebuchet MS\", Helvetica, sans-serif;    color: black;  font-size: 13px;display: inline-block;\n" +
