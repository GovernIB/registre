 ...
 *         &lt;element name="peticion" type="{http://types.registro.ws.rgeco.geiser.minhap.gob.es/}peticionRegistroType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "registrar", namespace = "http://registro.ws.rgeco.geiser.minhap.gob.es/", propOrder = {
    "authentication",
    "peticion"
})
public class Registrar {
    ...
    @XmlElement(namespace = "")
    protected PeticionRegistroType peticion;
     ...
     * @return
     *     possible object is
     *     {@link PeticionRegistroType }
     *     
     */
    public PeticionRegistroType getPeticion() {
        return peticion;
    }
     ...
     *     
     */
    public void setPeticion(PeticionRegistroType value) {
        this.peticion = value;
    }
