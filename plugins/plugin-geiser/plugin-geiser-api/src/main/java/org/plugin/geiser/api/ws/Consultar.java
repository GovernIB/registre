 ...
 *         &lt;element name="peticion" type="{http://types.registro.ws.rgeco.geiser.minhap.gob.es/}peticionConsultaType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "consultar", namespace = "http://registro.ws.rgeco.geiser.minhap.gob.es/", propOrder = {
    "authentication",
    "peticion"
})
public class Consultar {
    ...
    @XmlElement(namespace = "")
    protected PeticionConsultaType peticion;
     ...
     * @return
     *     possible object is
     *     {@link PeticionConsultaType }
     *     
     */
    public PeticionConsultaType getPeticion() {
        return peticion;
    }
     ...
     *     
     */
    public void setPeticion(PeticionConsultaType value) {
        this.peticion = value;
    }
