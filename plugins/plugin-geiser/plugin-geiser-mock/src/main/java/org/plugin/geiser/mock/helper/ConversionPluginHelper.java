package org.plugin.geiser.mock.helper;
...
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.AnexoType;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.CanalNotificacionEnum;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.EstadoAsientoEnum;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.InteresadoType;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.PeticionBusquedaEstadoTramitacionType;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.PeticionBusquedaType;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.PeticionConsultaType;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.PeticionRegistroEnvioSimpleType;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.PeticionRegistroType;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.TipoAsientoEnum;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.TipoDocAnexoEnum;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.TipoDocumentacionFisicaEnum;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.TipoEnvio;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.TipoFirmaEnum;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.TipoIdentificacionEnum;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.TipoTransporteEnum;
import es.gob.minhap.geiser.rgeco.ws.client.registro.types.ValidezDocumentoEnum;
