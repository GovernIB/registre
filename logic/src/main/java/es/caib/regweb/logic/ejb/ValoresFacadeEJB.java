...
public abstract class ValoresFacadeEJB extends HibernateEJB {
    ...
    */
    ...
    /**
     * Devuelve la lista de todos los organismos activos de la aplicaci�n
     * 
     * 
     * @return Vector de Strings. Por cada organismo a�ade un string con su c�digo, otro string con nombre corto y otro con su nombre largo. 
     * 		  En el caso de no encontrar nada env�a el vector con tres strings: <"&nbsp;","No hi ha Organismes","&nbsp;">
     * 
     * @throws EJBException
     * 
     * @ejb.interface-method
