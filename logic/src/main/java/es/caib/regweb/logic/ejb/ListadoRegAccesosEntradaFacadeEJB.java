 ...
 *
 * @ejb.bean
 *  name="logic/ListadoRegAccesosEntradaFacade"
 *  jndi-name="es.caib.regweb.logic.ListadoRegAccesosEntradaFacade"
 *  type="Stateless"
 *  view-type="remote"
 *  transaction-type="Container"
 *
 */
public abstract class ListadoRegAccesosEntradaFacadeEJB extends HibernateEJB {
	...
	public ListadoRegAccesosEntradaFacadeEJB() {
	}
...
//			Del tipus: 00:00:01:zzz
	...
	public Vector recuperar(ParametrosListadoAcceso parametros, String usuario, int sizePagina, int pagina) throws java.rmi.RemoteException {
		...
		try {
			...
			String sentenciaSql="SELECT FZTTIPAC, FZTCUSU, FZTDATAC, FZTHORAC, FZTNUMEN, FZTANOEN, FZTCAGCO, FAADAGCO " +
			" FROM BZENLPD LEFT JOIN BAGECOM ON FAACAGCO=FZTCAGCO " +
			...
			q.addScalar("FZTTIPAC", Hibernate.STRING);
            q.addScalar("FZTCUSU" , Hibernate.STRING);
            q.addScalar("FZTDATAC", Hibernate.INTEGER);
            q.addScalar("FZTHORAC", Hibernate.INTEGER);
            q.addScalar("FZTNUMEN", Hibernate.INTEGER);
            q.addScalar("FZTANOEN", Hibernate.INTEGER);
            q.addScalar("FZTCAGCO", Hibernate.INTEGER);
