...
//    int OFICIO_SIR_RECHAZADO = 12;
    ...
    int OFICIO_SIR_SIN_DATOS = 3;
    int OFICIO_SIR_PENDIENTE_ENVIO = 4;
    int OFICIO_SIR_ENVIADO_PENDIENTE_CONFIRMACION = 5;
    int OFICIO_SIR_ENVIADO_PENDIENTE_CONFIRMACION_MANUAL = 6;
    int OFICIO_SIR_RECIBIDO_PENDIENTE_CONFIRMACION = 7;
    int OFICIO_SIR_RECIBIDO_PENDIENTE_CONFIRMACION_MANUAL = 8;
    int OFICIO_SIR_ENVIADO_CONFIRMADO = 9;
    int OFICIO_SIR_RECIBIDO_CONFIRMADO = 10;
	int OFICIO_SIR_ENVIADO_RECHAZADO = 11;
	int OFICIO_SIR_RECIBIDO_RECHAZADO = 12;
	int OFICIO_SIR_REENVIADO = 13;
	int OFICIO_SIR_EN_TRAMITE = 14;
	int OFICIO_SIR_ASIGNADO = 15;
	int OFICIO_SIR_FINALIZADO = 16;
	int OFICIO_SIR_REENVIADO_RECHAZADO = 17;
	int OFICIO_SIR_RECTIFICADO = 18;
	int OFICIO_SIR_ENVIO_PROCESO = 19;
	int OFICIO_SIR_RECIBIDO_RECHAZADO_CIUDADANO = 20;
	int OFICIO_SIR_ELIMINADO = 21;
    
    int OFICIO_ANULADO = 22;
    ...
    Integer[] ESTADOS_OFICIO_REMISION_SIR = {
            OFICIO_ACEPTADO,
            OFICIO_SIR_SIN_DATOS,
            OFICIO_SIR_PENDIENTE_ENVIO,
            OFICIO_SIR_ENVIADO_PENDIENTE_CONFIRMACION,
            OFICIO_SIR_ENVIADO_PENDIENTE_CONFIRMACION_MANUAL,
            OFICIO_SIR_RECIBIDO_PENDIENTE_CONFIRMACION,
            OFICIO_SIR_RECIBIDO_PENDIENTE_CONFIRMACION_MANUAL,
            OFICIO_SIR_ENVIADO_CONFIRMADO,
            OFICIO_SIR_RECIBIDO_CONFIRMADO,
        	OFICIO_SIR_ENVIADO_RECHAZADO,
        	OFICIO_SIR_RECIBIDO_RECHAZADO,
            OFICIO_SIR_REENVIADO,
            OFICIO_SIR_EN_TRAMITE,
        	OFICIO_SIR_ASIGNADO,
        	OFICIO_SIR_FINALIZADO,
        	OFICIO_SIR_REENVIADO_RECHAZADO,
        	OFICIO_SIR_RECTIFICADO,
        	OFICIO_SIR_ENVIO_PROCESO,
        	OFICIO_SIR_RECIBIDO_RECHAZADO_CIUDADANO,
        	OFICIO_SIR_ELIMINADO
    };

    Integer[] ESTADOS_OFICIO_REMISION_SIR_FINALES = {
            OFICIO_ACEPTADO,
            OFICIO_SIR_ENVIADO_CONFIRMADO,
            OFICIO_SIR_RECIBIDO_CONFIRMADO,
        	OFICIO_SIR_ENVIADO_RECHAZADO,
    ...
    Long TRAZABILIDAD_SIR_DESCONOCIDO = 0L;
    Long TRAZABILIDAD_SIR_PENDIENTE = 1L;
    Long TRAZABILIDAD_SIR_RECEPCION = 2L; //RECIBIDO_CONFIRMADO
    Long TRAZABILIDAD_SIR_REENVIO = 3L; //REENVIADO
    Long TRAZABILIDAD_SIR_RECHAZO = 4L; //ENVIADO_RECHAZADO / RECIBIDO_RECHAZADO / REENVIADO_RECHAZADO
    Long TRAZABILIDAD_SIR_CONFIRMADO = 5L; //ENVIADO_CONFIRMADO
    Long TRAZABILIDAD_SIR_RECHAZO_ORIGEN = 6L;
    Long TRAZABILIDAD_SIR_ELIMINAR = 7L;
    Long TRAZABILIDAD_SIR_ANULAR = 8L;
    Long TRAZABILIDAD_SIR_RECTIFICADO = 9L;
    
    Long[] TIPOS_TRAZABILIDAD_SIR = {
    		TRAZABILIDAD_SIR_RECEPCION, TRAZABILIDAD_SIR_REENVIO, TRAZABILIDAD_SIR_RECHAZO,
            TRAZABILIDAD_SIR_CONFIRMADO, TRAZABILIDAD_SIR_RECHAZO_ORIGEN, TRAZABILIDAD_SIR_RECTIFICADO
    };
    ...
    */
    ...
    Long TIPO_DOCUMENTO_JUSTIFICANTE = 4L;
    ...
    String REMESA_ESTADO_REG_PENDIENTE = "PENDENT";
    String REMESA_ESTADO_REG_ENVIADA = "ENVIADA";
    String REMESA_ESTADO_REG_LEIDA = "LLEGIDA";
    String REMESA_ESTADO_REG_REGISTRADA = "REGISTRADA";
    String REMESA_ESTADO_REG_FINALIZADA = "FINALITZADA";
    String REMESA_ESTADO_REG_PROCESADA = "PROCESSADA";
...
//    String REMESA_ENV_ESTADO_RECHAZADA = "RECHAZADA";
//    String REMESA_ENV_ESTADO_ACEPTADA = "ACEPTADA";
    
    String REMESA_ENV_ESTADO_AUSENTE = "AUSENTE";
    String REMESA_ENV_ESTADO_DESCONOCIDO = "DESCONOCIDO";
    String REMESA_ENV_ESTADO_DIRECCION_INCO = "DIRECCION_INCORRECTA";
    String REMESA_ENV_ESTADO_ENVIADO_DEH = "ENVIADO_DEH";
    String REMESA_ENV_ESTADO_ENVIADO_CI = "ENVIADO_CI";
    String REMESA_ENV_ESTADO_ENTREGADO_OP = "ENTREGADO_OP";
    String REMESA_ENV_ESTADO_LEIDA = "LEIDA";
    String REMESA_ENV_ESTADO_ERROR = "ERROR";
    String REMESA_ENV_ESTADO_EXTRAVIADA = "EXTRAVIADA";
    String REMESA_ENV_ESTADO_FALLECIDO = "FALLECIDO";
    String REMESA_ENV_ESTADO_NOTIFICADA = "NOTIFICADA";
    String REMESA_ENV_ESTADO_PENDIENTE_ENVIO = "PENDIENTE_ENVIO";
    String REMESA_ENV_ESTADO_PENDIENTE_CIE = "PENDIENTE_CIE";
    String REMESA_ENV_ESTADO_PENDIENTE_DEH = "PENDIENTE_DEH";
    String REMESA_ENV_ESTADO_PENDIENTE_SEDE = "PENDIENTE_SEDE";
    String REMESA_ENV_ESTADO_REHUSADA = "REHUSADA";
    String REMESA_ENV_ESTADO_EXPIRADA = "EXPIRADA";
    String REMESA_ENV_ESTADO_ENVIO_PROGRAM = "ENVIO_PROGRAMADO";
    String REMESA_ENV_ESTADO_SIN_INFO = "SIN_INFORMACION";
    String REMESA_ENV_ESTADO_ANULADA = "ANULADA";
