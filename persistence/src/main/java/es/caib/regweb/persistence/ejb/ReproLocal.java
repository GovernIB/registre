...
public interface ReproLocal extends BaseEjb<Repro, Long> {
    ...
    /**
     * Obtiene la {@link es.caib.regweb.model.Repro} de un {@link es.caib.regweb.model.Usuario} con un orden
     * @param idUsuario
     * @param orden
     * @return
     * @throws Exception
    ...
    /**
     * Obtiene todas las {@link es.caib.regweb.model.Repro} de un {@link es.caib.regweb.model.Usuario}
     * @param idUsuario
     * @return
     * @throws Exception
     */
    ...
    /**
     * Obtiene las {@link es.caib.regweb.model.Repro} de un {@link es.caib.regweb.model.Usuario} Activas
     * @param idUsuario
     * @return
     * @throws Exception
     */
    ...
    /**
     * Obtiene el número total de {@link es.caib.regweb.model.Repro} de un {@link es.caib.regweb.model.Usuario}
     * @param idUsuario
     * @return
     * @throws Exception
     */
    ...
    /**
     * Obtiene el orden máximo de una {@link es.caib.regweb.model.Repro} existente
     * @param idUsuario
     * @return
     * @throws Exception
     */
    ...
    /**
     * Obtener usuario de una {@link es.caib.regweb.model.Repro}
     * @param idRepro
     * @return
     * @throws Exception
     */
    ...
    /**
     * Modifica orden en una {@link es.caib.regweb.model.Repro}
     *
     * @param idRepro
     * @param orden
     * @return
    ...
    /**
     * Sube orden en una {@link es.caib.regweb.model.Repro}
     *
     * @param idRepro
     * @return
     * @throws Exception
    ...
    /**
     * Baja orden en una {@link es.caib.regweb.model.Repro}
     * @param idRepro
     * @return
     * @throws Exception
     */
    ...
    /**
     * Cambiar estado de una {@link es.caib.regweb.model.Repro}
     * @param idRepro
     * @return
     * @throws Exception
     */
