...
public interface TipoAsuntoLocal extends BaseEjb<TipoAsunto, Long> {
    ...
    */
    ...
    /**
     * Retorna el {@link es.caib.regweb.model.TipoAsunto} asociado a un codigo.
     * @param codigo
     * @return
     * @throws Exception
     */
    ...
    /**
     * Retorna el {@link es.caib.regweb.model.TipoAsunto} asociado a un codigo y a una Entidad
     * @param codigo
     * @return
     * @throws Exception
     */
    ...
    /**
     * Obtiene el Total de {@link es.caib.regweb.model.TipoAsunto} asociado a una Entidad
     * @param idEntidad
     * @return
     * @throws Exception
     */
