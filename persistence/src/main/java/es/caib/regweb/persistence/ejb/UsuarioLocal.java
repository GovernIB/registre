...
public interface UsuarioLocal extends BaseEjb<Usuario, Long> {
    ...
    /**
     * Retorna el {@link es.caib.regweb.model.Usuario} asociado a un identificador.
     * @param identificador
     * @return
     * @throws Exception
     */
    ...
    /**
     * Retorna el {@link es.caib.regweb.model.Usuario} asociado a un documento.
     * @param documento
     * @return
     * @throws Exception
     */
    ...
    /**
     * Realiza una busqueda de {@link es.caib.regweb.model.Usuario} según los parámetros
     * @param pageNumber
     * @param nombre
     * @param identificador
     * @param apellido1
