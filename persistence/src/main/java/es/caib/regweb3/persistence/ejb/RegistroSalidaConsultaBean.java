...
public class RegistroSalidaConsultaBean implements RegistroSalidaConsultaLocal {
    ...
    public Paginacion busqueda(Integer pageNumber,List<Long> organismos, Date fechaInicio, Date fechaFin, RegistroSalida registroSalida, String interesadoNom, String interesadoLli1, String interesadoLli2, String interesadoDoc, String observaciones, String usuario, Long idEntidad, boolean incluirPendientesGeiser) throws Exception {
        ...
        if (incluirPendientesGeiser) {
	        where.add(" (registroSalida.fecha is null or (registroSalida.fecha >= :fechaInicio  ");
	...
	public RegistroSalida findByNumeroRegistro(String codigoEntidad, String numeroRegistro) throws Exception {
		...
		Query q = em.createQuery("Select rs from RegistroSalida as rs where rs.numeroRegistro = :numeroRegistro " +
                "and rs.usuario.entidad.codigoDir3 = :codigoEntidad ");
