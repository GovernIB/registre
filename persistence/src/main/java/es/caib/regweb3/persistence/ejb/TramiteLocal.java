...
public interface TramiteLocal  {
  ...
  public void clasificarRegistro(RegistroEntrada registroEntrada, UsuarioEntidad usuarioEntidad, ClasificacionDto clasificacionForm, Entidad entidad) throws Exception, I18NException;
