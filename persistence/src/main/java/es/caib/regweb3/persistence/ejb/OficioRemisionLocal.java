...
//    List<OficioRemision> getEnviadosErrorMaxReintentos(Long idEntidad) throws Exception;
	...
	void modificarFechaEstado(Long idOficioRemision, Date fechaEstado) throws Exception;
	...
	void actualizarMotivoRechazo(Long id, String motivoRechazo) throws Exception;
}
