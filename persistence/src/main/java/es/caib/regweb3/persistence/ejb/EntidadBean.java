...
public class EntidadBean extends BaseEjbJPA<Entidad, Long> implements EntidadLocal{
    ...
    public Entidad nuevaEntidad(Entidad entidad) throws Exception{
        ...
        propiedadGlobalEjb.persist(new PropiedadGlobal(RegwebConstantes.REGWEB3_PROPERTY_BASE+"avisos","true","Muestra o no los avisos pendientes", entidad.getId(), RegwebConstantes.TIPO_PROPIEDAD_GENERAL));
