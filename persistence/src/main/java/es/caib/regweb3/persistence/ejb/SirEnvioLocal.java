...
public interface SirEnvioLocal {
     ...
     * @return
     */
    RegistroEntrada aceptarRegistroSir(RegistroSir registroSir, Entidad entidad, UsuarioEntidad usuario, Oficina oficinaActiva, Long idLibro, Long idIdioma, List<CamposNTI> camposNTIs, Long idOrganismoDestino, Long codigoSia, String extracto, String emails, String motivo) throws I18NException, I18NValidationException;
