...
/**
 * <p>Clase Java para listarTipoDocumental complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listarTipoDocumental"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "listarTipoDocumental", propOrder = {
    "entidadCodigoDir3"
})
public class ListarTipoDocumental {
