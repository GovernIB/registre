...
public interface ListadoRegAccesosVisat  extends EJBObject  {
	
	public String getAnyRegistre()throws RemoteException;
	public void setAnyRegistre(String anyRegistre)throws RemoteException;
	public String getRegistreES() throws RemoteException;
	public void setRegistreES(String numRegistre) throws RemoteException;
