...
public class ListadoRegAccesosSortidaBean implements SessionBean {
	
	private static final Category log = Category.getInstance(ListadoRegAccesosSortidaBean.class.getName());
	...
	public ListadoRegAccesosSortidaBean() {
	}
...
//				 Point to the last row in resultset.
			...
			while (rs.next()) {
				...
				registro.setTipusAcces(rs.getString("FZUTIPAC"));
				registro.setUsuCanvi(rs.getString("FZUCUSU"));			
				String fechaES=String.valueOf(rs.getInt("FZUDATAC"));
				try {
				...
				/**  TODO: PARSEJAR HORA */   
				registro.setHoraCanvi( parsejarHora(String.valueOf(rs.getInt("FZUHORAC"))) );
				registro.setNombreRegistre(String.valueOf(rs.getInt("FZUNUMEN")));
				registro.setAnyRegistre(String.valueOf(rs.getInt("FZUANOEN")));
				registro.setOficinaRegistre(String.valueOf(rs.getInt("FZUCAGCO")));
				...
				psHist.setString(1,String.valueOf(rs.getInt("FZUCAGCO")));
