...
public interface OficioRemision extends EJBObject {
	...
	public String getFechaEntrada() throws RemoteException;
	public void setFechaEntrada(String fechaEntrada) throws RemoteException;
	...
	public String getOficinaSalida() throws RemoteException;
	public void setOficinaSalida(String oficinaSalida) throws RemoteException;
	...
	public String getFechaOficio() throws RemoteException;
	public void setFechaOficio(String fechaOficio) throws RemoteException;
	public String getDescripcion() throws RemoteException;
	public void setDescripcion(String descripcion) throws RemoteException;
	public String getNulo() throws RemoteException;
	public void setNulo(String nulo) throws RemoteException;
	public String getUsuarioNulo() throws RemoteException;
	public void setUsuarioNulo(String usuarioNulo) throws RemoteException;
	public String getMotivosNulo() throws RemoteException;
	public void setMotivosNulo(String motivosNulo) throws RemoteException;
	public String getFechaNulo() throws RemoteException;
	public void setFechaNulo(String fechaNulo) throws RemoteException;
	...
	public void grabar() throws SQLException, ClassNotFoundException, Exception, RemoteException;
	public void actualizar() throws SQLException, ClassNotFoundException, Exception, RemoteException;
	public void anular() throws SQLException, ClassNotFoundException, Exception, RemoteException;
    ...
    public String[] getRegistros() throws RemoteException;
	public void setRegistros(String[] registros) throws RemoteException;
