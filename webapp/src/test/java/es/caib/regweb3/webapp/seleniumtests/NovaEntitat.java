...
public class NovaEntitat extends RegistreSeleniumUtils {
  ...
  public void testNovaEntitat() throws Exception {
    ...
    */
    ...
    //assertEquals("/regweb3/tipoDocumental/12444/delete", closeAlertAndGetItsText());
    ...
    //acceptNextAlert = false;
    driver.findElement(By.cssSelector("span.fa.fa-eraser")).click();
    //assertEquals("/regweb3/tipoAsunto/12450/delete", closeAlertAndGetItsText());
    driver.findElement(By.id("okButton")).click();
    ...
    // assertEquals("/regweb3/entidad/12411/delete", closeAlertAndGetItsText());
    driver.findElement(By.id("okButton")).click();
