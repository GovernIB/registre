...
public class RegistroEntradaListController extends AbstractRegistroCommonListController {
    ...
    public String visarRegistroEntrada(@PathVariable Long idRegistro, HttpServletRequest request) {
        ...
        try {
            ...
            registroEntradaEjb.visarRegistroEntrada(registroEntrada, entidad, usuarioEntidad);
    ...
    public @ResponseBody JsonResponse distribuirRegistroEntrada(@PathVariable Long idRegistro, HttpServletRequest request,@RequestBody DistribuirForm distribuirForm) throws Exception {
