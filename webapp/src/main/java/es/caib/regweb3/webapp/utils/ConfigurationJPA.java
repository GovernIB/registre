...
public class ConfigurationJPA {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
    ...
    em.setPackagesToScan(new String[] { "es.caib.regweb3.model" });
  ...
  private Properties additionalProperties() {
    ...
    final String hibernateProp = RegwebConstantes.REGWEB3_PROPERTY_BASE + "hibernate.";
    final int cutIndex = RegwebConstantes.REGWEB3_PROPERTY_BASE.length();
