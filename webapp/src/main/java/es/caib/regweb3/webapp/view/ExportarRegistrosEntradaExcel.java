...
public class ExportarRegistrosEntradaExcel extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (int k = 0; k < hojasExcel; k++) {
            ...
            tittleCell.setCellValue(getMessage("registroEntrada.registroEntradas"));
            ...
            String[] capsalera = new String[]{"regweb.numero", "registroEntrada.fecha", "registroEntrada.oficina", "organismo.destino.corto","registroEntrada.estado","registroEntrada.extracto", "registro.presencial", "interesado.interesado", "usuario.usuario", "registroEntrada.aplicacion"};
            ...
            for (int i = inici; i < fi; i++) {
                ...
                if(!registroEntrada.getRegistroDetalle().getInteresados().isEmpty()){
                ...
                if(StringUtils.isNotEmpty(registroEntrada.getRegistroDetalle().getAplicacionTelematica())){
                    row.createCell(9).setCellValue(registroEntrada.getRegistroDetalle().getAplicacionTelematica());
                }else{
            ...
            String nombreFichero = getMessage("registroEntrada.registroEntradas") + "_"+ TimeUtils.imprimeFecha(new Date(), "dd-MM-yyyy") +".xls";
