package es.caib.regweb.webapp.controller.oficioRemision;
 ...
 * Controller que gestiona todas las operaciones con {@link es.caib.regweb.model.OficioRemision}
 * @author earrivi
 * @author anadal
 */
@Controller
...
public class OficioRemisionController extends BaseController {
    ...
    @EJB(mappedName = "regweb/OficioRemisionUtilsEJB/local")
    ...
    /**
     * Crea un nuevo {@link es.caib.regweb.model.OficioRemision} a partir de los
  ...
  /**
   * Crea un nuevo {@link es.caib.regweb.model.OficioRemision} hacia SIR a
  ...
  public ModelAndView oficioRemisionSir(@ModelAttribute SirForm sirForm, 
    ...
    /**
     * Carga el formulario para ver el detalle de un {@link es.caib.regweb.model.OficioRemision}
     */
    ...
    /**
     * Seleccionar un {@link es.caib.regweb.model.ModeloOficioRemision}
     */
    ...
    /**
     * Carga el formulario para procesar un {@link es.caib.regweb.model.OficioRemision}
     */
    ...
    /**
     * Procesa {@link es.caib.regweb.model.OficioRemision} pendiente de llegada, 
    ...
    public String procesarOficioRemision(
        ...
        try{
            registrosEntrada = oficioRemisionUtils.procesarOficioRemision(oficioRemision, usuarioEntidad, oficinaActiva, oficios);
        }catch (Exception e){
            e.printStackTrace();
        }
