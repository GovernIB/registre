...
import es.caib.regweb.webapp.form.UsuarioBusquedaForm;
import es.caib.regweb.webapp.utils.Mensaje;
import es.caib.regweb.webapp.utils.UsuarioService;
import es.caib.regweb.webapp.validator.UsuarioValidator;
...
public class UsuarioController extends BaseController {
    ...
    public IdiomaLocal idiomaEjb;
     ...
     /**
      * Carga el formulario para un nuevo {@link es.caib.regweb.model.Usuario}
      */
     ...
     /**
      * Carga el formulario para modificar un {@link es.caib.regweb.model.Usuario}
      */
     ...
     /**
      * Editar un {@link es.caib.regweb.model.Usuario}
      */
    ...
    public String nuevoUsuarioDocumento(@ModelAttribute Usuario usuario, BindingResult result, SessionStatus status, HttpServletRequest request) {
     ...
     /**
      * Eliminar un {@link es.caib.regweb.model.Usuario}
      */
