package es.caib.regweb.webapp.controller.persona;
...
import es.caib.regweb.webapp.form.PersonaBusquedaForm;
import es.caib.regweb.webapp.utils.JsonResponse;
import es.caib.regweb.webapp.utils.Mensaje;
import es.caib.regweb.webapp.utils.PersonaJson;
import es.caib.regweb.webapp.validator.PersonaWebValidator;
 ...
 * Controller que gestiona todas las operaciones con {@link es.caib.regweb.model.Persona}
 * @author mgonzalez
 */
@Controller
...
public class PersonaController extends BaseController {
    ...
    /**
     * Realiza la busqueda de {@link es.caib.regweb.model.Persona} según los parametros del formulario
     */
    ...
    public ModelAndView list(@ModelAttribute PersonaBusquedaForm busqueda, HttpServletRequest request)throws Exception {
     ...
     /**
      * Carga el formulario para un nuevo {@link es.caib.regweb.model.Persona}
      */
  ...
  /**
   * Guardar un nuevo {@link es.caib.regweb.model.Persona}
   */
  ...
  public void cleanEmptyValues(Persona persona) {
    ...
    if (persona.getPais() == null || persona.getPais().getId() == null) {
     ...
     /**
      * Carga el formulario para modificar un {@link es.caib.regweb.model.Persona}
      */
     ...
     /**
      * Editar un {@link es.caib.regweb.model.Persona}
      */
...
*/
    ...
    /**
     * Eliminar un {@link es.caib.regweb.model.Persona}
     */
    ...
    /**
     * Obtiene la {@link es.caib.regweb.model.Persona} según su identificador.
