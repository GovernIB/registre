...
<html>
	...
	<li><fmt:message key='seleccionar_oficina_de_sortida_per_visar'/></li>
	</ul>
	<!-- Fi Molla pa-->
		<br/>
		<br/>	
...
%>
   ...
   <%-- Fin de errores --%>
     		<br/>
	   <!--  <center><font class="titulo"><fmt:message key='selecciona_oficina_per_visar'/></font></center> -->
        <p>&nbsp;</p>
<!--   		<div id="RecuadreCentrat"> --> 
        <table align="center"  class="recuadroSalidas">
        <form name="busquedaForm" action="VisaSalidaLis.jsp" method="post">
        <tr>
            <td style="border:0">
            &nbsp;
            </td>
        ...
        <tr>
            <td style="border:0">
              ...
              <% escribeSelect(out, valores.buscarOficinas(usuario,"VS"), "");%>
                </select>
                &nbsp;&nbsp;
            </td>
        </tr>
