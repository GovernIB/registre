...
<p>
		...
		<li><fmt:message key='seleccionar_registre_sortida_a_visar'/></li>
		</ul>
		<!-- Fi Molla pa-->
<%
...
<table width="90%" border="1" align="center">
    ...
    <td align="center"><b><fmt:message key='d'/></b></td>
...
%>
    <tr class="<%=((i%2)==0)? "par":"impar"%>"> 
        ...
        <td align="center">
        <a href="VisaSalida.jsp?oficina=<%=reg.getNumeroOficina()%>&registro=<%=reg.getNumeroRegistro()%>&ano=<%=reg.getAnoRegistro()%>&fecha=<%=reg.getFechaModif()%>&hora=<%=reg.getHoraModif()%>">
            <img src="imagenes/open24.gif" border=0 alt="Visar camvi">
        </a>
        </td> 
        <td><%=numeroOficina%></td>
