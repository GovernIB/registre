...
<html>
    ...
    <body bgcolor="#FFFFFF">
        ...
        <% if(reg==null) {%>
        <center>
            <b>No s'ha trobat l'ofici: <%=oficio%>/<%=ano%></b>
        </center>
                ...
                <td class="cellaSortides" width="581">
                    <table width="100%" border=0>
                        <tr>
                            ...
                            <td style="border:0" >
                                Nº ofici: <font class="ficha"><%=ofi.getNumeroOficio()%>/<%=ofi.getAnoOficio()%></font>
                            </td>
                            <td style="border:0" >
                                <c:set var="texto" scope="page"><%=ofi.getFechaOficio()%></c:set>
                                Data ofici: <font class="ficha"><c:out escapeXml="false" value="${texto}"/></font>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0" >
                            ...
                            <td style="border:0" >
                                Ofici anul·lat:&nbsp;<%=(ofi.getNulo().trim().equals("") || ofi.getNulo().trim().equals("N")) ? "" : "S" %>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:0" >
