...
<%
    ...
    registroModificado.setAnoEntrada(Integer.parseInt(anoParm));
...
<%
    ...
    String anoEntrada=registroModificado.getAnoEntrada()+"";
    ...
    pregent.fijaUsuario(usuario);
    pregent.setoficina(oficina);
    pregent.setNumeroEntrada(numeroRegistro);  
    pregent.setAnoEntrada(anoEntrada);
    registro = regent.leer(pregent);
...
<%
    ...
    String originalRemitente=(registro.getEntidad1().trim().equals("")) ? registro.getDescripcionRemitente() : 
            registro.getEntidad1()+" - "+registro.getEntidad2()+"  "+registro.getDescripcionRemitente();
        ...
        <script>
            function valida() {
                ...
                <% } %>    ) {
                    ...
                    var continuar=confirm("No s'ha admés cap canvi. Confirmar");
                }
                return continuar;
            }
        </script>
...
<!--     <div align="center">
    ...
    <%-- Cuerpo y formulario --%>
    <form name="registroForm" action="VisaEntradaPaso.jsp" method="post" onsubmit="return valida()">
    <div align="center">
        <table>
                <tr>
                    <td>
                        <b><fmt:message key='entrada_a_visar'/></b>
                        <font style="font-size:14px; font: bold;background-color: #cccccc;">
                            &nbsp;&nbsp;&nbsp;<%=es.caib.regweb.webapp.servlet.HtmlGen.toHtml(numeroRegistro)%> &nbsp;&nbsp;/&nbsp;&nbsp;<%=es.caib.regweb.webapp.servlet.HtmlGen.toHtml(anoEntrada)%></b>
                        </font>
                    </td>
                </tr>
                <tr>
    ...
    <div align="center">
            ...
            <table border=0 width="70%" class="bordeEntrada">
                <% if (!entidad1.trim().equals("")) {%>
                    <tr>
                        <td width="5%">
