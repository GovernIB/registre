    ...
    $.sessionTimeout = function(options) {
        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            var coundownBarHtml = opt.countdownBar ?
                '<div class="progress"> \
                  <div class="progress-bar progress-bar-striped progress-bar-warning progress-bar-warning countdown-bar active" role="progressbar" style="min-width: 15px; width: 100%;"> \
