                       ...
                       <div class="panel panel-danger">
                           ...
                           <div class="panel-body">
                               ...
                               <div class="form-group col-xs-12">
                                   ...
                                   <div class="col-xs-8">
                                       <c:if test="${not empty registro.origen}">${registro.origen.denominacion}</c:if>
                                       <c:if test="${empty registro.origen}">${registro.origenExternoDenominacion}</c:if>
                                   </div>
                               </div>
                               ...
                               <c:if test="${not empty registro.registroDetalle.idioma}">
                                   <div class="form-group col-xs-12">
                                       ...
                                       <div class="col-xs-8"><spring:message code="idioma.${registro.registroDetalle.idioma}"/></div>
                                   </div>
                               </c:if>
                               ...
                               <div class="panel panel-warning">
                                   ...
                                   <div class="panel-body">
                                       ...
                                       <div class="form-group col-xs-12">
                                           ...
                                           <div class="col-xs-8">
                                               <c:if test="${not empty reOriginal.origen}">${reOriginal.origen.denominacion}
                                               </c:if>
                                               <c:if test="${empty reOriginal.origen}">${reOriginal.origenExternoDenominacion}</c:if>
                                           </div>
