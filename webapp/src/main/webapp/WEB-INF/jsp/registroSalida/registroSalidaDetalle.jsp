                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        ...
                        <dl class="detalle_registro">
                            ...
                            <c:if test="${not empty registro.registroDetalle.idioma}"><dt><i class="fa fa-bullhorn"></i> <spring:message code="registroEntrada.idioma"/>: </dt> <dd> ${registro.registroDetalle.idioma.nombre}</dd></c:if>
                    ...
                    <div class="panel-footer">  <%--Botonera--%>
                        ...
                        <c:if test="${registro.oficina.id == oficinaActiva.id}">
                            ...
                            <c:if test="${registro.estado == 8 && puedeEditar}">
                            ...
                            <c:if test="${registro.estado == 3 && isAdministradorLibro}">
                            ...
                            <%--Si el registro es oficio interno o externo--%>
                            <c:if test="${registro.estado == 4 || registro.estado == 5}">
                                <%--<button type="button" onclick='javascript:goTo("<c:url value="/oficioRemision/${registro.oficioRemisionDestino.id}/detalle"/>")' class="btn btn-warning btn-sm btn-block"><spring:message code="oficioRemision.detalle"/></button>--%>
                            </c:if>
            ...
            <c:if test="${!interesado.isRepresentante}">
                <c:choose>
                    <c:when test="${interesado.tipo == RegwebConstantes.TIPO_INTERESADO_ADMINISTRACION}">
                        ...
                        nombre = nombre.replace(/'/g, "\\'");
                        addOrganismoInteresadoHtml('${interesado.id}',nombre,'<spring:message code="interesado.administracion"/>','${registro.registroDetalle.id}');
                    </c:when>
