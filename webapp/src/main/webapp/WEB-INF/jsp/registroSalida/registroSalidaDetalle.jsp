...
<html lang="ca">
<head>
    <title><spring:message code="regweb.titulo"/> - <spring:message code="registroSalida.registroSalida"/> ${registro.numeroRegistroFormateado}</title>
                ...
                <div class="panel panel-danger">
                    ...
                    <c:if test="${registro.estado != RegwebConstantes.REGISTRO_PENDIENTE_VISAR && registro.estado != RegwebConstantes.REGISTRO_ANULADO}">
                        <div class="panel-footer center">
                            ...
                            <c:if test="${idJustificante == null && registro.estado != RegwebConstantes.REGISTRO_ANULADO && permisoEditar}">
                                <div class="btn-group">
                    ...
                    <div class="panel-footer center">
                        ...
                        <c:if test="${registro.estado == RegwebConstantes.REGISTRO_VALIDO && registro.registroDetalle.presencial && permisoEditar && !tieneJustificante}">
