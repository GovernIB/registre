...
<div class="container peu row-fluid">
    <div class="pull-left colophon"><spring:message code="regweb.titulo"/> &copy; | <fmt:message key="regweb.version"/> <%=Versio.VERSIO + (Configuracio.isCAIB()?"-caib":"") + " " + (Configuracio.showTimeStamp()?TimeStamp.TIMESTAMP : "") %></div>
