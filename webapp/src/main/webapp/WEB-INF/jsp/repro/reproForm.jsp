        ...
        <div class="row">
            <div class="col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-list-ul"></i> <spring:message code="repro.editar"/></li>
                </ol>
            </div>
        </div>
        <!-- Fin miga de pan -->
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-pencil-square-o"></i>
                            <strong><spring:message code="repro.editar"/> ${repro.nombre}</strong>
                        </h3>
                    </div>
                    <!-- Formulario -->
                    <div class="panel-body">
                        <form:form modelAttribute="repro" method="post" cssClass="form-horizontal">
                ...
                <input type="button" value="<spring:message code="regweb.cancelar"/>"
                       onclick="goTo('<c:url value="/repro/list"/>')" class="btn btn-sm">
