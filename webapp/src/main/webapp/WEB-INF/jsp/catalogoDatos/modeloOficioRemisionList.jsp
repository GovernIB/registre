            ...
            <div class="col-xs-12">
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-heading">
                        <a class="btn btn-success btn-xs pull-right" href="<c:url value="/modeloOficioRemision/new"/>" role="button"><span class="fa fa-plus"></span> <spring:message code="modeloOficioRemision.nuevo"/></a>
