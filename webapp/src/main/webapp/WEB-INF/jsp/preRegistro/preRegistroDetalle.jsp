                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body">
                        ...
                        <dl class="detalle_registro">
                            ...
                            <c:if test="${not empty preRegistro.registroDetalle.idioma}"><dt><i class="fa fa-bullhorn"></i> <spring:message code="preRegistro.idioma"/>: </dt> <dd> ${preRegistro.registroDetalle.idioma.nombre}</dd></c:if>
