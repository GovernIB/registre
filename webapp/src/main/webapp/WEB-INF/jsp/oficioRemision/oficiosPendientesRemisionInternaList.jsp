            ...
            <div class="col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-list-ul"></i> <strong><spring:message
                            code="registroEntrada.oficiosRemisionInterna"/></strong></li>
                            ...
                            <form:form modelAttribute="registroEntradaBusqueda" method="post" cssClass="form-horizontal">
                                ...
                                <%--<div class="form-group col-xs-6">
                                    <div class="col-xs-4 pull-left align-right"><spring:message
                                            code="registroEntrada.oficina"/></div>
                                    <div class="col-xs-8">
                                ...
                                <div class="form-group col-xs-6">
                                    <div class="col-xs-4 pull-left align-right"><spring:message
                                            code="registroEntrada.libro"/></div>
                                    <div class="col-xs-8">
                                ...
                                <div class="form-group col-xs-6">
                                    <div class="col-xs-4 pull-left align-right"><spring:message
                                            code="registroEntrada.anyRegistro"/></div>
                                    <div class="col-xs-8">
                                ...
                                <div class="form-group col-xs-6">
                                    <div class="col-xs-4 pull-left align-right"><spring:message
                                            code="registroEntrada.organDestinatari"/></div>
                                    <div class="col-xs-8">
                                        <form:select path="registroEntrada.destino.id" items="${organismosDestino}"
                                                     itemValue="id" itemLabel="denominacion" cssClass="chosen-select"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <c:if test="${paginacion.totalResults > 0}">
                                        ...
                                        <c:if test="${oficiosRemisionOrganismo.oficinas == false}">
                                            <div class="alert alert-danger center">
                                                <strong><spring:message code="oficioRemision.organismoDestino.oficinaRegistral"/></strong>
                                            </div>
                                        </c:if>
                                        ...
                                        <div class="table-responsive">
                                            <form:form action="${pageContext.request.contextPath}/oficioRemision/new"
                                                       id="oficio" modelAttribute="registroEntradaListForm"
                                                ...
                                                <table class="table table-bordered table-hover table-striped tablesorter">
                                                    ...
                                                    <tbody>
                                                    <c:forEach var="registroEntrada" items="${paginacion.listado}"
                                                               varStatus="indice">
                                                        <tr>
                                                            <td><form:checkbox id="oficio_id${indice.index}"
                                                                               path="registros[${indice.index}].id"
