...
<li>
<a href="javascript:void(0);"><span class="panel-heading btn-llibre vuitanta-percent" style="cursor:copy" onclick="copyToClipboard(this)"><i class="fa fa-book"></i> ${libroOrganismo.key}</span></a>
</li>
</c:if>
</c:forEach>
<!-- **** Oficinas ***-->
...
<li><a href="javascript:void(0);"><span class="panel-heading btn-ofaux vuitanta-percent" style="cursor:copy" onclick="copyToClipboard(this)"><i class="fa fa-home"></i> ${oficinasAuxiliar2.codigo} - ${oficinasAuxiliar2.denominacion}</span></a></li>
</c:if>
</c:forEach>
</ul>
</li>
...
<span class="panel-heading btn-primary vuitanta-percent" id="primerNivell${contadorPrimer}" style="cursor:copy" onclick="copyToClipboard(this)"><i class=""></i> ${organismo2.codigo} - ${organismo2.denominacion}</span>
</c:if>
<c:if test="${organismo2.edp == true}">
<span class="panel-heading btn-edp vuitanta-percent" id="primerNivell${contadorPrimer}" style="cursor:copy" onclick="copyToClipboard(this)"><i class=""></i> ${organismo2.codigo} - ${organismo2.denominacion}</span>
</c:if>
...
<li><a href="javascript:void(0);"><span class="panel-heading btn-llibre vuitanta-percent" style="cursor:copy" onclick="copyToClipboard(this)"><i class="fa fa-book"></i> ${libroOrganismo.key}</span></a></li>
</c:if>
</c:forEach>
<!-- **** Oficinas ***-->
<c:forEach var="oficinaPrincipal" items="${oficinasPrincipales}">
...
<c:forEach var="oficinaAuxiliar" items="${oficinasAuxiliares}">
<c:if test="${oficinaAuxiliar.oficinaResponsable.id == oficinaPrincipal.id}">
<li><a href="javascript:void(0);"><span class="panel-heading btn-ofaux vuitanta-percent" style="cursor:copy" onclick="copyToClipboard(this)"><i class="fa fa-home"></i> ${oficinaAuxiliar.codigo} - ${oficinaAuxiliar.denominacion}</span></a>
<c:forEach var="relacionOrganizativaOfi" items="${relacionesOrganizativaOfi}">
...
<span class="panel-heading btn-primary vuitanta-percent" id="segonNivell${contadorSegon}" style="cursor:copy" onclick="copyToClipboard(this)"><i class=""></i> ${organismo3.codigo} - ${organismo3.denominacion}</span>
</c:if>
<c:if test="${organismo3.edp == true}">
<span class="panel-heading btn-edp vuitanta-percent" id="segonNivell${contadorSegon}" style="cursor:copy" onclick="copyToClipboard(this)"><i class=""></i> ${organismo3.codigo} - ${organismo3.denominacion}</span>
</c:if>
...
<li><a href="javascript:void(0);"><span class="panel-heading btn-warning vuitanta-percent" style="cursor:copy" onclick="copyToClipboard(this)"><i class="fa fa-home"></i> ${oficinaPrincipal.codigo} - ${oficinaPrincipal.denominacion}</span></a>
<c:forEach var="relacionSirOfi" items="${relacionesSirOfi}">
...
<span class="panel-heading btn-primary vuitanta-percent" id="tercerNivell${contadorTercer}" style="cursor:copy" onclick="copyToClipboard(this)"><i class=""></i> ${organismo4.codigo} - ${organismo4.denominacion}</span>
</c:if>
<c:if test="${organismo4.edp == true}">
<span class="panel-heading btn-edp vuitanta-percent" id="tercerNivell${contadorTercer}" style="cursor:copy" onclick="copyToClipboard(this)"><i class=""></i> ${organismo4.codigo} - ${organismo4.denominacion}</span>
</c:if>
...
<span class="panel-heading btn-primary vuitanta-percent" id="cinqueNivell${contadorCinque}" style="cursor:copy" onclick="copyToClipboard(this)"><i class=""></i> ${organismo6.codigo} - ${organismo6.denominacion}</span>
</c:if>
<c:if test="${organismo6.edp == true}">
<span class="panel-heading btn-edp vuitanta-percent" id="cinqueNivell${contadorCinque}" style="cursor:copy" onclick="copyToClipboard(this)"><i class=""></i> ${organismo6.codigo} - ${organismo6.denominacion}</span>
</c:if>
...
<span class="panel-heading btn-primary vuitanta-percent" id="siseNivell${contadorSise}" style="cursor:copy" onclick="copyToClipboard(this)"><i class=""></i> ${organismo7.codigo} - ${organismo7.denominacion}</span>
</c:if>
<c:if test="${organismo7.edp == true}">
<span class="panel-heading btn-edp vuitanta-percent" id="siseNivell${contadorSise}" style="cursor:copy" onclick="copyToClipboard(this)"><i class=""></i> ${organismo7.codigo} - ${organismo7.denominacion}</span>
</c:if>
