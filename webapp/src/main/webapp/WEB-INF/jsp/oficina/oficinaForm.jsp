        ...
        <div class="row">
            <div class="col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<c:url value="/oficina/list"/>"><i class="fa fa-list-ul"></i> <spring:message
            ...
            <div class="col-xs-12">
                <form:form modelAttribute="oficina" method="post" cssClass="form-horizontal">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-xs-6">
                                <div class="col-xs-4 pull-left etiqueta_regweb control-label">
                                    <form:label path="organismoResponsable.id"><span class="text-danger">*</span>
                            ...
                            <div class="form-group col-xs-6">
                                <div class="col-xs-4 pull-left etiqueta_regweb control-label">
                                    <form:label path="oficinaResponsable"><span class="text-danger">*</span>
                    ...
                    <input type="button" value="<spring:message code="regweb.cancelar"/>"
                           onclick="goTo('<c:url value="/oficina/list"/>')" class="btn btn-sm">
