                                ...
                                <div class="timeline-body">
                                    ...
                                    <p>
                                        <small><i class="fa fa-bookmark"></i> <strong><spring:message code="oficioRemision.estado"/>:</strong>
                                            <c:if test="${trazabilidad.oficioRemision.estado == RegwebConstantes.OFICIO_REMISION_INTERNO_ESTADO_ENVIADO}"><span class="label label-warning"></c:if>
                                            <c:if test="${trazabilidad.oficioRemision.estado == RegwebConstantes.OFICIO_REMISION_ESTADO_ENVIADO}"><span class="label label-warning"></c:if>
                                            <c:if test="${trazabilidad.oficioRemision.estado == RegwebConstantes.OFICIO_REMISION_ESTADO_ACEPTADO}"><span class="label label-success"></c:if>
                                            <c:if test="${trazabilidad.oficioRemision.estado == RegwebConstantes.OFICIO_REMISION_ESTADO_ANULADO}"><span class="label label-danger"></c:if>
