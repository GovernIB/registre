               ...
               <div class="col-xs-6">
                   ...
                   <div class="panel panel-info">
                       ...
                       <div class="panel-body">
                           ...
                           <div class="form-group col-xs-12">
                               <div class="col-xs-2 pull-left etiqueta_regweb control-label">
                                   <label for="registroDetalle.extracto" rel="ayuda" data-content="<spring:message code="registro.ayuda.extracto"/>" data-toggle="popover"><span class="text-danger">*</span> <spring:message code="registroEntrada.extracto"/></label>
                               </div>
                               <div class="col-xs-10">
