        ...
        <div class="row">
            <div class="col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-list-ul"></i> <strong><spring:message code="registroEntrada.registroEntradas"/> <spring:message code="registro.estado.${estado}" /></strong></li>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-search"></i>
                            <strong><spring:message code="registroEntrada.listado"/> <spring:message code="registro.estado.${estado}" /></strong>
                        </h3>
                    </div>
