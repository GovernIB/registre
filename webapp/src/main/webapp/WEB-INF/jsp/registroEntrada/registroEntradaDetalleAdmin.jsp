                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-footer center">
                        <c:if test="${registro.estado != RegwebConstantes.REGISTRO_RESERVA}">
                            ...
                            <c:if test="${!tieneJustificante && idJustificante == null && registro.estado != RegwebConstantes.REGISTRO_ANULADO}">
                                <div class="btn-group">
                    ...
                    <div id="contenido" class="tab-content contentInfo">
                        ...
                        <c:if test="${tieneJustificante}">
                            <div class="tab-pane" id="justificante">
                                <div class="col-xs-12">
                                    <dl class="detalle_registro">
                                        <c:if test="${not registro.registroDetalle.justificanteGeiser}">
                                        ...
                                        <c:if test="${registro.registroDetalle.justificanteGeiser}">
                                            <dt><i class="fa fa-home"></i> Custodiado: </dt> <dd> GEISER</dd>
                                        </c:if>
                                    </dl>
                                </div>
                            </div>
