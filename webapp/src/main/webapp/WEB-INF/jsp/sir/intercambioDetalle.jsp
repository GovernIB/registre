                                                ...
                                                <c:forEach var="trazabilidad" items="${trazabilidades}">
                                                    ...
                                                    <c:if test="${trazabilidad.oficioRemision.estado != RegwebConstantes.OFICIO_SIR_ENVIADO}">
                                                        <a href="javascript:void(0);" class="list-group-item">
                                                            ...
                                                            <c:if test="${trazabilidad.oficioRemision.estado == RegwebConstantes.OFICIO_SIR_REENVIADO_ACK}"><span class="label label-success"><i class="fa fa-check fa-fw"></i></c:if>
