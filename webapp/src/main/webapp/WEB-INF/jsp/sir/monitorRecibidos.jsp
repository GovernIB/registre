...
<html lang="ca">
    <head>
        <title><spring:message code="regweb.titulo"/> - <spring:message code="registroSir.buscador.recibidos"/></title>
                                                        ...
                                                        <td class="center">
                                                            <div class="btn-group pull-right text12">
                                                                ...
                                                                <ul class="dropdown-menu dropdown">
                                                                    <li><a href="<c:url value="/sir/recibido/${registroSir.id}/detalle"/>" target="_blank"><spring:message code="idIntercambio.detalle"/></a></li>
