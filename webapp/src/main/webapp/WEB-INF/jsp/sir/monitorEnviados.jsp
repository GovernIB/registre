                                                            ...
                                                            <div class="btn-group pull-right text12">
                                                                ...
                                                                <ul class="dropdown-menu dropdown">
                                                                    ...
                                                                    <c:if test="${oficioRemision.estado != RegwebConstantes.OFICIO_ACEPTADO && oficioRemision.estado != RegwebConstantes.OFICIO_SIR_ENVIADO_CONFIRMADO &&
                                                                    	...
                                                                    	<li><a href="javascript:void(0);" onclick="actualizarRegistroSir('${oficioRemision.id}','${urlActualizar}', '<spring:message code="registroSir.actualizar.mensaje"/>')"><spring:message code="registroSir.actualizar"/></a></li>
