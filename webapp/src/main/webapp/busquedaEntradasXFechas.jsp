        ...
        <tr>
            ...
            <td style="border:0">
                <select name="oficinaDesde" id="oficinaDesde"  onchange="refrescaFisica()">
                    <% escribeSelect(out, "", valores.buscarOficinas(usuario,"CE"), (parametros==null) ? "": parametros.getOficinaDesde());%>
                </select>
            </td>
            <td style="border:0">
                <select name="oficinaHasta" id="oficinaHasta"  onchange="refrescaFisica()">
                    <% escribeSelect(out, "", valores.buscarOficinas(usuario,"CE"), (parametros==null)? "": parametros.getOficinaHasta());%>
                </select>
            </td>
        </tr>
        <tr>
