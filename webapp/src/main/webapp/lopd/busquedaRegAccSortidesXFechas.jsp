...
listado=(ParametrosListadoAcceso)session.getAttribute("listadoRegAcESSortida");
%>
<%! 
...
<html>
    ...
    <body>
		...
		<ul id="mollaPa">
			...
			<li><fmt:message key='consulta_log_sortides'/></li>
		</ul>
		<!-- Fi Molla pa-->
    <p>&nbsp;</p>

        <center><font class="titulo"><fmt:message key='consulta_log_sortides'/></font></center>&nbsp;<p>
        ...
        <form name="busquedaForm" action="listadoRegAccSortida.jsp" method="post">
