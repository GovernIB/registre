...
<body>
		...
		<ul id="mollaPa">
			...
			<li><a href="busquedaRegAccVisatsEntXFechas.jsp"><fmt:message key='consulta_log_visats'/></a></li>
			<li><fmt:message key='lopd.llistat_log_visat_entrades'/></li>
		</ul>
		<!-- Fi Molla pa-->
		<p>&nbsp;</p>
<%
...
/* No hi ha cap element al llistat, eliminam el llistat de la sessió.*/
        	session.removeAttribute("listadoRegAcEVisat");
        	%>
<p></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<center>[&nbsp;<a href="busquedaRegAccVisatsEntXFechas.jsp"><fmt:message key='consulta_log_visats'/></a>&nbsp;]</center>
     <% } else { %>
...
<table border="0" align="center"><!--width="95%"--> 
    <tr>
        ...
        <td align="center" width="33%">
            [&nbsp;<a href="<%=(request.getParameter("any")==null) ? "busquedaRegAccVisatsEntXFechas.jsp" : "busquedaRegAccVisatsEntXFechas.jsp"%>"><fmt:message key='tornar_seleccionar'/></a>&nbsp;]
        </td>
