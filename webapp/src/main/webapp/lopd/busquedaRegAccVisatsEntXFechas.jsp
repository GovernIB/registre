...
listado=(ParametrosListadoAcceso)session.getAttribute("listadoRegAcEVisat");
%>
<%! 
...
<html>
    ...
    <p>&nbsp;</p>
        ...
        <center><font class="titulo"><fmt:message key='consulta_log_entrada_visat'/></font></center>&nbsp;<p>
        ...
        <form name="busquedaForm" action="listadoRegAccEntVisats.jsp" method="post">
...
<!--        </td>
        ...
        <tr>
            <td style="border:0" colspan="3" height="5px">
              ...
              <input type="hidden" name="registreES" id="registreES" size="1" maxlength="1" value="E">
