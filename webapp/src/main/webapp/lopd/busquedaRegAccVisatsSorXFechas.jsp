...
listado=(ParametrosListadoAcceso)session.getAttribute("listadoRegAcSVisat");
%>
<%! 
...
<html>
    ...
    <body>
		...
		<ul id="mollaPa">
			...
			<li><fmt:message key='consulta_log_visats'/></li>
		</ul>
		<!-- Fi Molla pa-->
    <p>&nbsp;</p>

        <center><font class="titulo">Consulta log de modificacions de sortida amb visat</font></center>&nbsp;<p>
        ...
        <form name="busquedaForm" action="listadoRegAccSorVisats.jsp" method="post">
        ...
        <tr>
            ...
            <td style="border:0">
                <select name="oficinaDesde"> 
                    <% escribeSelect(out, "", valores.buscarOficinas(usuario,"AS"), (listado==null)? "":listado.getOficinaDesde());%>
                </select>
            </td>
            <td style="border:0">
                <select name="oficinaHasta">
                    <% escribeSelect(out, "", valores.buscarOficinas(usuario,"AS"), (listado==null)? "":listado.getOficinaHasta());%>
                </select>
            </td>
        </tr>
        <tr>
        ...
        <tr>
        <td style="border:0">
            &nbsp;<br>&nbsp;<fmt:message key='lopd.data_visat'/>................:
        </td>
        <td style="border:0">
...
<!--        <tr>
        ...
        <tr>
        <td style="border:0">
            &nbsp;<br>&nbsp;<fmt:message key='lopd.entrada_sortida'/>........:
        </td>
        <td style="border:0">-->
<!--        </td>
        ...
        <tr>
            <td style="border:0" colspan="3" height="5px">
              <%String anteriorES=(listado==null)? "":listado.getNumRegistre();%>
              <input type="hidden" name="registreES" id="registreES" size="1" maxlength="1" value="S">
