 ...
 *
 */
public enum EstadoAsientoRegistral {
    ...
    EstadoAsientoRegistral(String value, String name) {
        this.value = value;
        this.name = name;
    }
    ...
    public static EstadoAsientoRegistral getEstadoAsientoRegistral(String value) {

        if (value != null) {

            for (EstadoAsientoRegistral e : EstadoAsientoRegistral.values()) {
