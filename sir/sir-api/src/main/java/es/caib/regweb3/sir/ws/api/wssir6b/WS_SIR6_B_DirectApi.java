...
public class WS_SIR6_B_DirectApi {
    ...
    public static es.caib.regweb3.sir.ws.api.wssir6b.RespuestaWS recepcionFicheroDeAplicacion(String xml, String strURL)
            throws Exception {
        int pos = xml.indexOf('\n');
        ...
        try {
            ...
            es.caib.regweb3.sir.ws.api.wssir6b.RespuestaWS resp = new es.caib.regweb3.sir.ws.api.wssir6b.RespuestaWS();
